...
description: "Bu makalede Microsoft Dynamics 365 for Finance and Operations'ı nasıl kişiselleştirebileceğiniz açıklanmaktadır."
author: RobinARH
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
Bu makalede Microsoft Dynamics 365 for Finance and Operations'ı nasıl kişiselleştirebileceğiniz açıklanmaktadır.
...
Bir sayfayı kişiselleştirdikten sonra, kişiselleştirmelerinizi diğer kullanıcılarla paylaşabilirsiniz. Tek yapmanız gereken kişiselleştirilmiş sayfayı dışa aktarmak. Daha sonra diğer kullanıcıların kişiselleştirilmiş sayfaya gitmelerini ve oluşturmuş olduğunuz kişiselleştirme dosyasını içe aktarmalarını isteyebilirsiniz.

Yönetici ayrıcalıklarına sahip kullanıcılar, bu kişi **Kişiselleştirme** sayfasında diğer kullanıcılara ait kişiselleştirmeleri de yönetebilir. Bu sayfa dört sekmeye sahiptir: **Sistem**, **Kullanıcılar**, **İçe Aktar** ve **Temizle**.
