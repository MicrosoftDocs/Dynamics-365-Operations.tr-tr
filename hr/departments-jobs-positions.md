---
title: "Departmanlar, projeler ve pozisyonları kullanarak işgücünüzün düzenlemek"
...
# <a name="organize-your-workforce-using-departments-jobs-and-positions"></a>Departmanlar, projeler ve pozisyonları kullanarak işgücünüzün düzenlemek
...
|**Accounting**|Muhasebe gözetmeni|Muhasebe müdürü|
|**Accounting**|Muhasebe-A|Muhasebeci|
|**Human resources**|İK yöneticisi (Doğu)|İK yöneticisi|
|**Human resources**|İK yöneticisi (Batı)|İK yöneticisi|
|**Human resources**|İK yöneticisi (Merkezi)|İK yöneticisi|
...
İş işlevleri iş görevleri gibidir. Bir iş işlevi, projeye atanan bir veya daha fazla görevi veya sorumluluğu açıklar. İş işlevlerini projelere atanan ve ayarlamak ve maaş planları için uygunluk kuralları uygulamak için kullanılır. İş işlevleri örnekleri aşağıdaki tabloda listelenir.
...
Pozisyonlar, organizasyon hiyerarşisinin alt düzeylerinin önemli bir öğesidir. Bir pozisyon, bir işin bireysel eşdüşümüdür. Örneğin, konum, "(Doğu), satış yöneticisi" işlemiyle ilişkili olduğu pozisyon "Satış Yöneticisi" biridir Pozisyonlar bir bölümünde mevcut ve işçilere atanır.
