...
description: Bu makalede, bir onay adımının özelliklerinin nasıl yapılandırılacağı açıklanmaktadır.
author: ChrisGarty
ms.date: 08/23/2017
ms.topic: article
ms.prod: ''
...
Bu makalede, bir onay adımının özelliklerinin nasıl yapılandırılacağı açıklanmaktadır.
