...
description: Bu makalede, kuruluşunuzda size yardımcı olacak kaynaklar açıklanmaktadır.
author: sericks007
ms.date: 08/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8882063"
---
# <a name="organization-administration-home-page"></a>Kuruluş yönetimi giriş sayfası

[!include [banner](../includes/banner.md)]

Bu makalede kullanıcı ve yöneticilerin sistemi kuruluşunuz ve işletmeniz için sorunsuz ve etkili çalışacak şekilde yapılandırmalarına yardımcı olacak içerikler sunulmaktadır.
