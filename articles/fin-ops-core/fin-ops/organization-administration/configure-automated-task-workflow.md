...
description: Bu makalede, otomatik bir görevin özelliklerinin nasıl yapılandırılacağı açıklanmaktadır.
author: ChrisGarty
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Bu makalede, otomatik bir görevin özelliklerinin nasıl yapılandırılacağı açıklanmaktadır.
