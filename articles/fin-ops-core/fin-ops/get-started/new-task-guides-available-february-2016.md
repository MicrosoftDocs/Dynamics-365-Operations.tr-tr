...
description: Bu makalede, Microsoft BPM kitaplıklarında Şubat 2016 itibariyle yayımlanan Görev kılavuzları listelenmektedir.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861748"
---
# <a name="new-task-guides-february-2016"></a>Yeni görev kılavuzları (Şubat 2016)

[!include [banner](../includes/banner.md)]

Bu makalede, Microsoft BPM kitaplıklarında Şubat 2016 itibariyle yayımlanan Görev kılavuzları listelenmektedir. Yayımlanmış olan kitaplıklar arasında (Şubat 2016) APQC Unified Library for Microsoft Dynamics AX ve (Şubat 2016) Başlangıç bulunmaktadır.
