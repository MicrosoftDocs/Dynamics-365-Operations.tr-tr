...
description: Bu makalede, eklenmiş resim ve şekillere sahip iş belgeleri oluşturmak için Elektronik raporlama aracının nasıl kullanılacağı açıklanmaktadır.
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
