...
description: Bu konu, sayfa üst bilgilerinde veya alt bilgilerinde katıştırılmış resim ve şekillere sahip iş belgeleri oluşturmak için elektronik raporlama (ER)) kullanmayı açıklamaktadır.
author: NickSelin
ms.date: 06/28/2021
ms.topic: article
ms.prod: ''
