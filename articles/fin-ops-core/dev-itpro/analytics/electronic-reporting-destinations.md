...
> [!NOTE]
> Basit Posta Aktarım Protokolü (SMTP) sunucusu yapılandırılmalı ve kullanılmalıdır. SMTP sunucunuzu **Sistem yönetimi** &gt; **Kurulum** &gt; **E-posta** &gt; **E-posta parametreleri** altından belirtebilirsiniz.
...
> [!NOTE]
> İş arşivi için belge türünü **Kuruluş yönetimi** &gt; **Çalışma alanları** &gt; **Elektronik raporlama** &gt; **Elektronik raporlama parametreleri** altından seçebilirsiniz.
