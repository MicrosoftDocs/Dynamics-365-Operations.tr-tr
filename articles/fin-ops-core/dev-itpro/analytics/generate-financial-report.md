...
Rapor oluşturma işlemi sürerken, **Rapor kuyruğu durumu** sayfasında aşağıdaki rapor kuyruğu durumu göstergeleri görüntülenebilir.

| Çalıştırma Durumu          | Durum | Açıklama|
|-----------------|--------|--------------------|
...
1. **Report Designer**'da **Dosya** menüsünde, **Yeni**'yi seçin ve ardından **Rapor planı**'nı seçin. **Yeni rapor planı** iletişim kutusu açılır.
...
7. **Yinelenme modeli** alanında, raporun ne sıklıkta çalıştırılacağını belirtin. Varsayılan olarak, **Günlük** **1** **Aralık (gün)** değeriyle birlikte seçilir. Diğer seçenekler **Haftalık**, **Aylık** ve **Yıllık**'tır.
8. **Yinelenme aralığı** alanında, oluşturulan raporun ne zamana durdurulması gerektiğini seçin.
...
1. Report Designer'daki gezinti bölmesinde **Rapor planları**'nı seçin ve kopyalamak için bir rapor planı açın.
...
1. Report Designer'da gezinti bölmesinde **Rapor planları**'nı seçin.
...
1. Report Designer'da, **Araçlar**'ı ve ardından **Eksik hesap analizi**'ni seçin.
...
8. Ele aldığınız özel durumları yenilemek için **Yenile**'yi seçin. Tüm sonuçları tamamen yenilemek için **Evet**'i, ele alınan maddeleri kısmen yenilemek için ise **Hayır**'ı seçin.
    ...
    > [!NOTE]
    > Form, sayfa son 15 dakikada açılmadığı sürece açıldığında otomatik olarak yenilenir.
