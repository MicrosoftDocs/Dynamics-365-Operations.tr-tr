...
description: Bu makalede filtreler, sınırlamalar, yazdırılmayan satırlar ve hesaplamalarda koşullu deyimler dahil olmak üzere gelişmiş biçimlendirme işlevleri açıklanmaktadır.
author: panolte
ms.date: 04/26/2019
ms.topic: article
ms.prod: ''
