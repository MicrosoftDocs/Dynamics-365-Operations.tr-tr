...
| NOW () | Geçerli uygulama sunucusu tarih ve saatini bir tarih/saat değeri olarak döndürür. | |
| TODAY () | Geçerli uygulama sunucusu tarihini bir tarih değeri olarak döndürür. | |
| NULLDATE () | Bir **null** tarih değeri döndür. | |
| NULLDATETIME () | Bir **boş** tarih/saat değeri döndürür. | |
| DATETIMEFORMAT (datetime, biçim) | Belirtilen tarih/saat değerini belirtilen bir biçimdeki dizeye dönüştürür. (Desteklenen biçimler hakkında daha fazla bilgi için bkz. [standart](https://msdn.microsoft.com/library/az4se3k1(v=vs.110).aspx) ve [özel](https://msdn.microsoft.com/library/8kb3ddd4(v=vs.110).aspx).) | **DATETIMEFORMAT (NOW(), "dd-MM-yyyy")** Aralık 24, 2015 olan uygulama sunucusu tarihini belirtilen özel biçimi temel alarak **"24-12-2015"** olarak döndürür. |
| DATETIMEFORMAT (datetime, biçim, kültür) | Belirtilen tarih/saat değerini ve [kültürü](https://msdn.microsoft.com/goglobal/bb896001.aspx) belirtilen bir biçimdeki dizeye dönüştürür. (Desteklenen biçimler hakkında daha fazla bilgi için bkz. [standart](https://msdn.microsoft.com/library/az4se3k1(v=vs.110).aspx) ve [özel](https://msdn.microsoft.com/library/8kb3ddd4(v=vs.110).aspx).) | **DATETIMEFORMAT (NOW(), "d", "de")** Aralık 24, 2015 olan geçerli uygulama sunucusu tarihini seçilen Alman kültürünü temel alarak **"24.12.2015"** olarak döndürür. |
| SESSIONTODAY () | Geçerli uygulama oturumu tarihini bir tarih değeri olarak döndürür. | |
| SESSIONNOW () | Geçerli uygulama oturumu tarih ve saatini bir tarih/saat değeri olarak döndürür. | |
| DATEFORMAT (tarih, biçim) | Belirtilen tarihin, belirtilen biçimdeki dize olarak temsilini döndür. | **DATEFORMAT (SESSIONTODAY (), "dd-MM-yyyy")** Aralık 24, 2015 olan uygulama oturum tarihini belirtilen özel biçimi temel alarak **"24-12-2015"** olarak döndürür. |
| DATEFORMAT (tarih, biçim, kültür) | Belirtilen tarih değerini, belirtilen biçimde ve [kültür](https://msdn.microsoft.com/goglobal/bb896001.aspx)'de bir dizeye dönüştürür. (Desteklenen biçimler hakkında daha fazla bilgi için bkz. [standart](https://msdn.microsoft.com/library/az4se3k1(v=vs.110).aspx) ve [özel](https://msdn.microsoft.com/library/8kb3ddd4(v=vs.110).aspx).) | **DATETIMEFORMAT (SESSIONNOW (), "d", "de")** Aralık 24, 2015 olan geçerli uygulama oturumu tarihini seçilen Alman kültürünü temel alarak **"24.12.2015"** olarak döndürür. |
...
| İşlev | Açıklama | Örnek |
|----------|-------------|---------|
| CONVERTCURRENCY (tutar, kaynak para birimi, hedef para birimi, tarih, şirket) | Belirtilen parasal tutarı belirtilen kaynak para biriminden, belirtilen tarihte şirketin belirtilen ayarları kullanarak hedef para birimine dönüştür. | **CONVERTCURRENCY (1, "EUR", "USD", TODAY(), "DEMF")**, şimdiki oturum tarihinde, DEMF şirket ayarlarına dayalı olarak bir euro'nun ABD doları olarak karşılığını döndürür. |
| ROUNDAMOUNT (sayı, ondalık, yuvarlama kuralı) | Belirtilen yuvarlama kuralına göre belirtilen tutarı belirtilen ondalık basamak sayısına yuvarlar.<blockquote>[!NOTE] Yuvarlama kuralı **RoundOffType** numaralandırmasının bir değeri olarak belirtilmelidir.</blockquote> | **model.RoundOff** parametresi **Aşağıya** olarak ayarlanırsa, **ROUNDAMOUNT (1000.787, 2, model.RoundOff)** **1000.78** değerini döndürür. Eğer **model.RoundOff** parametresi **Normal** ya da **Yukarıya yuvarla** olarak ayarlanmışsa, **ROUNDAMOUNT (1000.787, 2, model.RoundOff)**, **1000,79** değerini döndürür. |
...
| GetCurrentCompany () | Bir kullanıcının oturum açmış olduğu tüzel kişiliğin (şirket) kodunun metin olarak gösterimini döndürür. | **GETCURRENTCOMPANY ()**, **Contoso Entertainment System USA** şirketinde oturum açmış bir kullanıcı için **USMF** döndürür. |
