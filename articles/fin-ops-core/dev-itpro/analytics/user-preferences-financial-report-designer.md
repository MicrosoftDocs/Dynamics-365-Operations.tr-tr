...
description: Bu makalede, mali rapor tasarımcısında kullanıcı etkileşimlerinizi özelleştirmek için kullanıcı tercihlerinizi nasıl ayarlayacağınız ve ilk oturum açma deneyiminizi nasıl kontrol edeceğiniz açıklanmaktadır.
author: aprilolson
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
