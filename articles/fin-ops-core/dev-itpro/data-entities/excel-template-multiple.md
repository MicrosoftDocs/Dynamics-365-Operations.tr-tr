...
description: Bu makalede, Excel veri varlığı şablonlarını kullanarak finans ve operasyon uygulamasına veri aktarma işlemi açıklanmaktadır.
author: peakerbl
ms.date: 01/01/2018
ms.topic: article
ms.prod: ''
