## <a name="customers-v3-to-accounts"></a>Müşteriler V3 ve hesaplar

Bu şablon, Finance and Operations uygulamaları ve Common Data Service arasında verileri eşitler.

Kaynak filtresi: ((PartyType == "Kuruluş"))

Ters kaynak filtresi: customertypecode eq 3
...
hiçbiri | >> | address1_addresstypecode | 2
hiçbiri | >> | customertypecode | 3
PARTYTYPE | << | hiçbiri | Kuruluş
