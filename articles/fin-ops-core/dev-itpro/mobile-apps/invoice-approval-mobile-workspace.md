...
description: Bu makalede, Fatura onayları mobil çalışma alanı hakkında bilgi sağlanmaktadır.
author: abruer
ms.date: 05/24/2022
ms.topic: article
ms.prod: ''
...
<tbody>
<tr class="odd">
<td>Microsoft Dynamics 365 Finance kuruluşunuzda dağıtılmış olmalıdır.</td>
