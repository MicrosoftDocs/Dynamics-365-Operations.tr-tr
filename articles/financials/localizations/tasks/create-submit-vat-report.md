...
Bu yordam, Alman yetkilileri için KDV raporu oluşturma ve gönderme sürecini gösterir.

Bu yöntem oluşturulurken DEMF demo verisi şirketi kullanılmıştır. 

Bu işlevsellik, birincil adresi Almanya içinde olan tüzel kişilikler için kullanılabilir.
