...
<span data-ttu-id="65795-109">Toplam harcırah tutarı hesaplaması, **Harcırah** formunda ayarlayabileceğiniz başlangıç ve bitiş tarihlerine dayanarak hesaplanır.</span><span class="sxs-lookup"><span data-stu-id="65795-109">The calculation of a total per diem amount is based on the start dates and end dates that you can set on the **Per diems** page.</span></span>
