...
**Project Service Automation tümleştirme parametreleri** sayfasında Microsoft Dynamics 365 for Project Service Automation ile Microsoft Dynamics 365 for Finance and Operations'ı tümleştirirken varsayılan verilerin girilme şeklini yapılandırabilirsiniz. Projelerin Project Service Automation'dan Finance and Operations'a başarıyla eşitlenebilmesi için aşağıdaki alanları ayarlamanız gerekir.
