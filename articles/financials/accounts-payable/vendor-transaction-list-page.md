...
# <a name="vendor-transaction-list-page"></a>Satıcı hareketi listesi sayfası
...
2. Hareketleri olan bir satıcı seçin ve ardından **Satıcı \> Hareketler** seçeneğini belirleyin.
3. Araştırılacak hareketi seçin.
4. Eylem bölmesindeki **Kapatmaları görüntüle** sekmesini seçin.

    **Kapatmaları görüntüle** iletişim kutusu açılır ve seçili hareket ile buna karşılık kapatılan tüm belgeleri gösterir. Bu iletişim kutusu, kapatmalar geçmişi görünümüne benzer ancak tüm ilgili belgeleri de içerir.
