...
---
# <a name="map-models--to-use-financial-dimensions-as-a-data-source-for-electronic-reporting-er"></a>Elektronik raporlama (ER) için mali boyutları veri kaynağı olarak kullanmak üzere modelleri eşleme
