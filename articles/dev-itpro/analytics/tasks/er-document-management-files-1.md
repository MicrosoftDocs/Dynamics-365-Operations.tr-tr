...
---
# <a name="prepare-data-models-to-use-document-management-files-in-er-output"></a>ER çıktılarında Belge Yönetimi dosyalarını kullanmak için veri modelleri hazırlama
