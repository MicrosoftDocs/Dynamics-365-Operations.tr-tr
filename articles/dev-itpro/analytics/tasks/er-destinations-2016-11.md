--- 
title: "Elektronik raporlama (ER) çıktısı için hedefleri yapılandırma"
...
---
# <a name="configure-destinations-for-electronic-reporting-er-output"></a>Elektronik raporlama (ER) çıktısı için hedefleri yapılandırma
