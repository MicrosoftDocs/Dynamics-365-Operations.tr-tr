...
Oluşturulan ER meta veri yapılandırması, RCS'ye alınabilecek ve Finance and Operations'taki dış ticari işletme etki alanının meta verileri hakkında bilgi kaynağı olarak kullanılabilen bir XML dosyası olarak kaydedildi. Bu bilgiye dayanarak uygulama meta verileri ve ER veri modeli arasındaki eşlemeyi belirtebiliriz.
