...
4. **Dosya** ve ardından **Farklı Kaydet** seçimlerini yapın ve Rapor Öznitelikler İçeren Ayrıntılı Mizan adın verin.
    ...
    > [!NOTE]
    > Rapor tasarımcısında ne zaman yeni bir rapor oluşturulsa Finance and Operations'ta mali raporlar listesi güncelleştirilir.
...
[Mali raporları görüntüleme](../../financials/general-ledger/view-financial-reports.md)
