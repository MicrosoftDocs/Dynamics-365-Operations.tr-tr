...
Oluşturulan raporun bir örneği aşağıda sunulmuştur.
...
6.  **Hesap** iletişim kutusunda, listeden hesap adını seçin veua **Arama** alanında girişi arayın. Ardından **Tamam**'ı tıklatın.
