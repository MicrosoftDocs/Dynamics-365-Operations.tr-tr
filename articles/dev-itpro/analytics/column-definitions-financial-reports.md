...
| Şirket bilgilerindeki işlevsel para birimi | **YEN**              | **60 $**: Sonuç yalnızca JPY olarak girilen hareketleri gösterir ve ABD doları cinsinden olan hareketleri görüntüler. **Not:** Dönüşüm oranı USD başına yaklaşık 100 JPY'dir.                    |
| Şirket bilgilerinden işlevsel para birimi | Boş                | **$2.310\*\*** – Sonuç tüm verileri şirket bilgilerinde belirtilen işlevsel para biriminde gösterir. **Not:** Bu tutar işlevsel para birimindeki tüm işlemlerin toplamıdır. |
