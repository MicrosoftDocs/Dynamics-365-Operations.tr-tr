...
Microsoft Dynamics 365 for Finance and Operations'ta, [Ürün yerelleştirme ve çeviri bulunabilirliği kılavuzu](https://aka.ms/ax-availabilityguide)'nda belirtilen ülkelere/bölgelere yönelik işlevler bulunur. Bu işlev, etkin tüzel kişiliğin birincil adresi esas alınarak etkinleştirilir. 
...
-   [Elektronik raporlama aracını kullanarak elektronik belgeler oluşturma ve uygulama verilerini güncelleştirme](../analytics/generate-electronic-documents-update-application-data.md)
...
### <a name="chinafinancialslocalizationschinamd"></a>[Çin](../../financials/localizations/china.md)
...
### <a name="estoniafinancialslocalizationsestoniamd"></a>[Estonya](../../financials/localizations/estonia.md)
