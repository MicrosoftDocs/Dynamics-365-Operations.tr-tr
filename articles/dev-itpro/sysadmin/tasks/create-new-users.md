...
2. Yeni'ye tıklayın.
3. Kullanıcı kimliği alanında bir değer girin.
    * Kullanıcı için benzersiz bir tanımlayıcı girin. Bir kullanıcı kimliği gereklidir.  
4. Kullanıcı adı alanına bir değer girin.
    * Kullanıcının adını girin.  
5. Etki alanı alanına bir değer yazın.
    * Kullanıcının etki alanını girin.  
6. Diğer adı alanına bir değer yazın.
    * Kullanıcının diğer adını girin.  
7. Şirket alanında, aramayı açmak için açılır menü düğmesine tıklayın.
8. Listede, istenen kaydı bulun ve seçin.
9. Listede, seçili satırdaki bağlantıya tıklayın.
    * Kullanıcının şirketini seçin  
10. Rolleri ata'ya tıklayın.
11. Listede, istenen kaydı bulun ve seçin.
12. Tamam'a tıklayın.
13. Kaydet'e tıklayın.

## <a name="import-users"></a>Kullanıcıları içe aktar
1. Kullanıcıları içe aktar'a tıklayın.
