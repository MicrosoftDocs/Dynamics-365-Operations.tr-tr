...
Tek işlemli tasarımcıyı mağazalar, kayıtlar, kasiyerler ve yöneticiler için Yatay modda veya Dikey Modda farklı Retail Modern POS (MPOS) ve Bulut POS düzenleri tasarlamak için kullanabilirsiniz.
...
[Retail Modern POS yapılandırma, indirme, yükleme ve etkinleştirme](retail-modern-pos-device-activation.md)
