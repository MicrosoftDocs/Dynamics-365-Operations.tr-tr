...
ms.locfileid: "6356233"
---
# <a name="revenue-recognition-reallocation--scenario-1"></a>Gelir kabulü yeniden tahsisatı – Senaryo 1

[!include [banner](../includes/banner.md)]

Bu konu, iki satış siparişinin girildiği, ancak yalnızca onaylandığı bir yeniden tahsisat senaryosunu ele alır. İkiden fazla satış siparişi onaylanmış durumdaysa aynı senaryo benzer sonuçlar doğurur.
