...
> [!NOTE]
> Bu işlevler, Eylül 2022'de kullanımdan kaldırılacağından yeni kullanıcılar elektronik raporlama kullanmalıdır. Daha fazla bilgi için bkz. [Elektronik raporlamayı kullanarak pozitif ödeme dosyaları ayarlama](set-up-positive-pay-er.md).
