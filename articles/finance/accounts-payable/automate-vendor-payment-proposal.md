...
description: Bu makalede, satıcılara yinelenen bir plana göre ödeme yapan kuruluşların satıcı ödeme teklifleri oluşturma işlemini nasıl otomatikleştirebileceği açıklanmaktadır.
author: kweekley
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> Bu işlevden yararlanmak için, **Satıcı ödeme teklifi otomasyonu** özelliği Özellik yönetiminde etkinleştirilmelidir. 
