...
description: Bu makalede, Elektronik raporlama kullanılarak pozitif ödemenin nasıl ayarlanacağı açıklanmıştır.
author: panolte
ms.date: 03/20/2022
ms.topic: article
ms.prod: ''
...
Bu makalede, Elektronik raporlama kullanılarak pozitif ödemenin nasıl ayarlanacağı ve pozitif ödeme dosyalarının nasıl oluşturulacağı açıklanmıştır.
