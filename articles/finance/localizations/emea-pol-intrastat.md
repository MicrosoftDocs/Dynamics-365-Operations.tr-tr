...
16. **Tamam**'ı seçin ve XML biçiminde oluşturulan raporu inceleyin. Aşağıdaki tabloda örnek raporlardaki değerler gösterilmektedir.
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Belge hakkındaki bilgiler</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Şirketle ilgili bilgiler</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Mal hakkında bilgiler</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>İletişim bilgileri</strong></p>
    </td>
    </tr>
    <tr>
    <td>
