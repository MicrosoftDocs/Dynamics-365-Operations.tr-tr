...
description: Bu makalede, tüzel kişilikler için Kaynakta Kesilen Vergi (TDS) kayıt numaralarının nasıl ayarlanacağı açıklanmaktadır.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8859751"
---
# <a name="set-up-tds-registration-numbers-for-legal-entities"></a>Tüzel kişilikler için TDS kayıt numaralarını ayarlama

[!include [banner](../includes/banner.md)]

Bu makalede, tüzel kişilikler için Kaynakta Kesilen Vergi (TDS) kayıt numaralarının nasıl ayarlanacağı açıklanmaktadır.
