...
description: Bu makalede, Avrupa için Microsoft Dynamics 365 Finance belgesi kaynaklarının bağlantıları yer almaktadır.
author: kfend
ms.date: 01/15/2022
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8856532"
---
# <a name="europe-overview"></a>Avrupa'ya genel bakış

[!include [banner](../includes/banner.md)]

Bu makalede, birincil adresi Avrupa'da olan tüzel kişilikler ayarlamanıza yardımcı olabilecek kaynakların bağlantıları ve bilgiler yer almaktadır. 

- [Avans sahiplerine genel bakış](emea-advance-holders.md)
 - [Avans sahibi hareketleri](emea-advance-holders-transactions.md)
 - [Personele avans ödemesi](tasks/advance-payment-employee.md)
- [Doğru Avrupa'ya yönelik avans faturaları](emea-advance-invoice.md)
- [Banka ekstresi ve ödeme mutabakatı](emea-bank-reconciliation.md)
- [Düzeltici faturalama](emea-corrective-invoice.md)
- [Periyodik günlüklerde bölünmüş dönemler](emea-create-post-periodic-journals.md)
- [Hesaptan ödeme talimatları olan bir müşteri için ödemeler oluşturma](tasks/create-payments-customers-who-have-direct-debit-mandates.md)
...
- [İntrastat'a genel bakış](emea-intrastat.md)
  - [Hareketleri İntrastat'a transfer etme](tasks/transfer-transactions-intrastat.md)
  - [Topluluk içi bir hareket için yükleme adresi belirtme](tasks/eur-00002-specify-lading-address-intra-community.md)
...
- [Fatura sorun son tarihi](emea-invoice-issue-deadline.md)
...
- [Doğu Avrupa ve Rusya'ya yönelik kasa](emea-petty-cash.md)
...
- [AB giriş sertifikasını alma](tasks/eur-00012-receive-eu-entry-certificate.md)
- [Kayıt kodları](emea-registration-ids.md)
- [Ters kaydedilecek KDV](emea-reverse-charge.md)
...
- Katma Değer Vergisi (KDV)
  - [KDV Kodu ayarlama](tasks/eur-00015-vat-id.md)
  - [Satıcı KDV Kimliği'nin kaydı](tasks/eur-00015-registration-vendor-vat-id.md)
  - [KDV döviz kuruna genel bakış](emea-vat-exchange-rate.md)
  - [KDV mutabakatı raporu](tasks/eur-00018-vat-reconciliation-report.md)
  - [Doğu Avrupa için KDV kayıt hareketleri](emea-vat-register-transactions.md)
