...
Finance kuruluşunuza dağıtıldıysa sistem yöneticisinin **Project Time Entry** mobil çalışma alanını yayımlaması gerekir. Yönergeler için bkz: [Bir mobil çalışma alanı yayımlama](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
