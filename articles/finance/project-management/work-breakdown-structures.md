---
title: İş kırılım yapılarına genel bakış
...
ms.locfileid: "2174409"
---
# <a name="work-breakdown-structures-overview"></a>İş kırılım yapılarına genel bakış
...
WBS oluşturma genellikle uzun dönemde yayılan yoğun bir süreçtir ve çok sayıda, farklı insanın işbirliğini ve bilgisini gerektirir. Bu konu, tahminler ve izleme için gereksinimlerinizi karşılayacak WBS ilerlemelerini nasıl kullanabileceğinizi açıklamaktadır.
...
**Görev zaman planlaması** Aşağıdaki faktörler alt düğüm görevlerinin zamanlamasını belirler:
...
Bazı durumlarda bu kurallardan sapmak isteyebilirsiniz. Finance'in alt düğüm görevlerinin özelliklerini otomatik olarak ayarlamasını veya düzeltmesini önlemek için otomatik zamanlamayı devre dışı bırakabilirsiniz. Bir görev için, zamanlama kurallarının ihlaline neden olan bilgiler girdiğiniz zaman, görev için bir zamanlama hatası simgesi gösterilir. Zamanlama hatalarının görüntülenmesini istemiyorsanız, **Zamanlama hataları gösterilir**'e tıklayarak özelliği devre dışı bırakın. 
...
**Tüm zamanlama hatalarını düzeltme** Finance'in WBS'deki tüm zamanlama hatalarını düzeltmesini istiyorsanız **Tüm zamanlama uyuşmazlıklarını düzelt**'e tıklayın. 
...
Bir proje WBS'si için Finance'in üç görünümü vardır: Planlama görünümü, İş gücü izleme görünümü ve Maliyet izleme görünümü.
...
Finance, planlanan değerin grafiğini çıkarırken 0:100 kazanç kuralını kullanır. Bu kurala göre, görevin değeri, göreve bitiş tarihi itibariyle verilir. Görev yüzde 100 tamamlanana kadar hiçbir değer nakledilmez. 
...
Finance, kazanılan değerin grafiğini çıkarırken 0:100 kazanç kuralını kullanır. Bu kurala göre, görevin değeri, göreve bitiş tarihi itibariyle verilir. Görev yüzde 100 tamamlanana kadar hiçbir değer nakledilmez. 
