...
Bu mobil çalışma alanı, Dynamics 365 Unified Ops mobil uygulaması ile kullanılmak üzere geliştirilmiştir.
...
- Bir girişin fotoğrafını çekin ve Dynamics 365 Finance'a yükleyin. Daha sonra fotoğrafı bir gider raporuna ekleyebilirsiniz.
...
Ayrıca şu özellikleri kullanabilirsiniz:
...
Önkoşullar, kuruluşunuza dağıtılan sürüme dayalı olarak değişiklik gösterir.

### <a name="prerequisites-if-you-use-dynamics-365-finance"></a>Dynamics 365 Finance kullanıyorsanız önkoşullar 
Finance kuruluşunuza dağıtıldıysa sistem yöneticisinin **Gider yönetimi** mobil çalışma alanını yayımlaması gerekir. Yönergeler için bkz: [Bir mobil çalışma alanı yayımlama](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
...
Dynamics 365 Unified Ops mobil uygulamasını yükleyin ve kurun:
