...
description: Bu makale, verginin fişteki yanlış genel muhasebe hesabına nakledilmesiyle ilgili sorun giderme bilgileri sağlar.
author: qire
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
Deftere nakledilme sırasında, vergi fişte yanlış genel muhasebe hesabına nakledilebilir. Bu sorunu gidermek için, aşağıdaki bölümlerde gereken adımları izleyin. Bu makaledeki örneklerde, iş belgesi olarak bir satış siparişi kullanılır.
