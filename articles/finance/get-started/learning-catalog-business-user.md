...
| İçerik | Açıklama | Biçim | Uzunluk |
|---------|-------------|--------|--------|
| [Dynamics 365 Finance'teki genel muhasebeyi yapılandırma ve kullanma](/learn/paths/configure-use-general-ledger-dyn365-finance/) | Dynamics 365 Finance, iş kullanıcılarının diledikleri zaman mali planlama ve tahminlere yönelik doğru bilgilerle finansmanları denetleyip fonları yönetmelerine ve analizlerle yenilikleri takip etmelerine destek olur. Finans işletmenin merkezini oluşturduğundan, Genel muhasebe modülü de mali yönetimin merkezidir. Bu öğrenme yolunda size Genel muhasebe modülündeki işlevleri nasıl ayarlayabileceğiniz gösterilmektedir. Ayrıca, bir dönem veya bir yıl için kapanış prosedürlerinin nasıl tamamlanacağını kapsar.    | Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 13.5 saat  |
| [Dynamics 365 Finance'te nakit ve banka yönetimi ile satış vergisini yapılandırma ve yönetme](/learn/paths/configure-use-cash-bank-management-tax-dyn365-finance/)    | Bir kuruluşun banka hesaplarını ve bu banka hesapları ile ilişkili olan mali araçları korumak için Dynamics 365 Finance'teki Nakit ve banka yönetimi modülünü kullanabilirsiniz. Tüm işletmelerin vergi tahsil edip çeşitli vergi kuruluşlarına vergi ödemeleri gerekir. Bu öğrenme yolunda Dynamics 365 Finance'in bu alanlarını nasıl yapılandırıp kullanabileceğinizi öğreneceksiniz | Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 7.5 saat |
| [Dynamics 365 Finance'te Borç hesapları ile çalışma](/learn/paths/work-accounts-payable-dyn365-finance/)    | Borç hesapları, önceden nakit ödeme yapmadan ürün veya hizmet sipariş ettiğinizde bir alacaklıdan kaynaklanan bir pasiftir, ki bu durum, ürünleri krediyle satın aldığınız anlamına gelir. Borç hesaplarını Dynamics 365 Finance'te yapılandırmayı, satıcı faturalarını kaydetmeyi ve vergi, resim ve harçları hesaplar arasında dağıtmayı öğrenin. | Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 5.5 saat |
| [Dynamics 365 Finance'te Alacak hesapları ile çalışma](/learn/paths/work-accounts-receivable-dyn365-finance/)  | Müşteri faturaları oluşturmak, sevk irsaliyelerini deftere nakletmek ve satış siparişleriyle ilgili olmayan serbest metin faturalarını kullanmak için Dynamics 365 Finance'teki Alacak hesapları modülünü yapılandırın. Bu öğrenme yolunda, alacak hesaplarında günlük görevleri nasıl gerçekleştirebileceğinizi de öğreneceksiniz      | Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 7 saat   |
| [Dynamics 365 Finance'te bütçelemeyi yapılandırma ve kullanma](/learn/paths/configure-use-budgeting-dyn365-finance/)   | Özel kuruluş veya kamu kuruluşu olsun her kuruluş, bütçeleri oluşturarak mali ve operasyonel hedefleri belirler. Bütçe planlamasının işbirlikçi ve işlem temelli yapısı sayesinde bütçe işleminizi daha verimli hale getirebilirsiniz. | Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 3.5 saat |
| [Dynamics 365 Finance'te sabit kıymetleri ve kıymet kiralamayı yapılandırma ve yönetme](/learn/paths/configure-manage-fixed-assets-dyn365-finance/) | Sabit kıymetler için satın alma bilgileri oluşturup girebilir, daha sonra amortisman ayırarak ve bir aktifleştirme eşiği ayarlayarak bunları yönetebilirsiniz. Sabit kıymetlerin işlenme şekli, hem uluslararası muhasebe standartlarına hem de her ülke veya bölgedeki muhasebe mevzuatına uygun olmalıdır. Kıymet kiralama, Dynamics 365 Finance'teki kiralanan mülkler için finansal hareketleri izleme, takip etme ve otomatikleştirme özelliğidir.| Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 6.5 saat |
| [Dynamics 365 Finance'te tedarik zincirleri için maliyet muhasebesini kullanmaya başlama](/learn/paths/get-started-cost-accounting-supply-chains-dyn365-finance/) | Maliyet muhasebesi; genel muhasebe, muavin defterler, bütçeler ve istatistiksel bilgiler gibi çeşitli kaynaklardan veri toplamanıza olanak sağlar. Maliyet verilerini analiz edebilir, özetleyebilir ve değerlendirebilirsiniz. Böylece yönetim; fiyat güncelleştirmeleri, bütçeler, maliyet kontrolü ve benzer konularda en iyi kararları verebilir.  | Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 1 saat  |
| [Dynamics 365 Project Operations'da gider yönetimiyle çalışma](/learn/paths/work-expense-management/) | Dynamics 365 Project Operations'da doğru gider yönetimi özellikleriyle karlılığı en üst düzeye çıkarın ve maliyeti azaltın. Sistemi yapılandırmayı ve gider raporlarını oluşturma ve onaylamayı öğrenin. | Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 5.5 saat  |
