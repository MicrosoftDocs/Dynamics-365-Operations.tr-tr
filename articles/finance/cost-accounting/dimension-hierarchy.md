...
description: Bu makalede, boyut hiyerarşileri hakkında bilgiler sağlanmaktadır. Maliyet muhasebesi içerisinde ayarlanmış raporlama yapısını, maliyet ilkelerini ve güvenlik gruplarını tanımlamak için bir boyut hiyerarşisi kullanırsınız.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848649"
---
# <a name="dimension-hierarchy"></a>Boyut hiyerarşisi

[!include [banner](../includes/banner.md)]

Bu makalede, boyut hiyerarşileri hakkında bilgiler sağlanmaktadır. Maliyet muhasebesi içerisinde ayarlanmış raporlama yapısını, maliyet ilkelerini ve güvenlik gruplarını tanımlamak için bir boyut hiyerarşisi kullanırsınız.  
