...
1. LCS'de Dynamics 365 Finance ortamı oluşturun veya güncelleştirin. Ortam, 10.0.21 veya daha sonraki bir sürümü gerektirir.
...
- Finance Insights eklentisini yükleyen kullanıcıya Dynamics 365 Finance veya eşdeğer bir lisans uygulanır.
...
- LCS'de ortam sayfasını açın ve **Power Platform Tümleştirme** bölümünün ayarlı olduğunu doğrulayın.
...
## <a name="one-last-thing"></a>Son olarak...

Eklenti başarıyla yüklendikten sonra Dynamics 365 Finance'te **Özellik yönetimi** çalışma alanında Finance Insights özelliklerinin etkinleştirilmesi bir saatten fazla sürebilir. Bu kadar beklemek istemiyorsanız **Insights sağlama durumu denetimi** işlemini el ile çalıştırabilirsiniz. 
