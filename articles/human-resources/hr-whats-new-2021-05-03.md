---
title: Dynamics 365 Human Resources'daki yenilikler veya değişiklikler (3 Mayıs 2021)
description: Bu konuda, 3 Mayıs 2021 için Microsoft Dynamics 365 Human Resources'taki yeni veya değişen özellikler açıklanmaktadır.
author: marcelbf
ms.date: 05/03/2021
ms.topic: article
ms.prod: ''
...
Bu sürüm aşağıdaki yeni özellikleri ve hata düzeltmelerini içerir. Değişiklikler derleme numarası 8.1.4140 uygulanır.
...
| --- | --- | --- |
| Yaşam olayları oluşturulduğunda bilgi çubuğu ekler. | - | Yaşam olayı oluşturduğunuzda, bilgi çubuğu oluşturulan yaşam olayının türünü belirten bir ileti görüntüler.
...
| --- | --- | --- |
| 559312 |  Bir çalışan için sabit ücret planı oluşturulurken düzey gösterilmez. |  Kullanıcının saat dilimi ve şirket saat dilimi arasında saat dilimi uyumsuzluğu olduğunda, işteki ücret düzeyi okunamadı. Sorgu, UTC saatine göre getirilecek şekilde güncelleştirildi. |
| 573676  | **Kazançlar planı** formuna yeni dönem eklenemez. | **Yeni** düğmesi, **Kazanç planları**'ndaki **Dönem** hızlı sekmesinin altında etkinleştirilecek şekilde form güncelleştirildi. |
...
| İzin tahakkuku hareketi denetleme | - | [İzin tahakkuku hareketi denetleme](hr-leave-and-absence-accrue.md#preview-leave-accrual-transaction-auditing)|
