...
Hizmet güncelleştirme işlemi hakkında daha fazla bilgi için [Güncelleştirme işlemi](https://docs.microsoft.com/dynamics365/human-resources/hr-admin-setup-update-process)'ne bakın.
