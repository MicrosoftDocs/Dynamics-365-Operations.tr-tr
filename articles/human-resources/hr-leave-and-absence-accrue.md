...
3. **İzin ve devamsızlık planları tahakkuk et** iletişim kutusunda, **başlangıç olarak**, **bugünün tarihini** seçin veya **özel tarih**'i seçin ve özel bir tarih girin.
...
## <a name="preview-features-for-leave-and-absence"></a>İzin ve devamsızlık için Önizleme özellikleri

[!include [banner](includes/preview-feature-leave-absence.md)]

İzin ve devamsızlık için aşağıdaki Önizleme özelliklerini etkinleştirebilirsiniz:

- **İzin ve devamsızlık tahakkuklarını sil**'yi seçin. Belirli bir plan ve tarih aralığı için tahakkuk kayıtlarını silin. Tahakkuk tarihleri bugün veya gelecekte olmalıdır.

- **İzin tahakkuku denetimi**. Bir kişi bir veya tüm çalışanlar için bir tahakkuku her çalıştırdığında veya bu tarihle birlikte eylemi gerçekleştiren bir tahakkuk sildiği zaman görüntüler.
