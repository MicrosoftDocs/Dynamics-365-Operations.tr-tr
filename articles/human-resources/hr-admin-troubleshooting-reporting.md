...
description: Bu makalede, Microsoft Dynamics 365 Human Resources raporlarının nasıl özelleştirileceği veya yeni raporların nasıl oluşturulacağı açıklanmaktadır.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
