...
---
# <a name="example-query-for-recruiting-request"></a><span data-ttu-id="0b1f2-103">Işe alma isteği için sorgu örneği</span><span class="sxs-lookup"><span data-stu-id="0b1f2-103">Example query for Recruiting request</span></span>

<span data-ttu-id="0b1f2-104">Bu konu, Dynamics 365 Human Resources'taki İşe alma isteği varlığı için örnek bir sorgu sağlar.</span><span class="sxs-lookup"><span data-stu-id="0b1f2-104">This topic provides an example query for the Recruiting request entity in Dynamics 365 Human Resources.</span></span>

<span data-ttu-id="0b1f2-105">Aşağıdaki sorgu, belirli bir işe alma isteği kaydı ve belirtilen istekle ilgili tüm ilişkili pozisyonlar, gerekli yetenekler ve Eğitim gereksinimlerini almak için $expand sorgu seçeneğini bir alma işlemi içinde nasıl kullanabileceğinizi gösterir.</span><span class="sxs-lookup"><span data-stu-id="0b1f2-105">The following query shows how you can use the $expand query option in a GET operation to retrieve a specified recruiting request record and all associated positions, required skills, and educational requirements for the specified request.</span></span> <span data-ttu-id="0b1f2-106">Örnek yanıt, iki pozisyon için işe alma isteğini ve istenen pozisyonlar için gerekli becerileri ve eğitim bilgilerini gösterir.</span><span class="sxs-lookup"><span data-stu-id="0b1f2-106">The example response shows a recruiting request for two positions, and the required skills and education for the requested positions.</span></span>

<span data-ttu-id="0b1f2-107">**İstek**</span><span class="sxs-lookup"><span data-stu-id="0b1f2-107">**Request**</span></span>
...
<span data-ttu-id="0b1f2-108">**Yanıt**</span><span class="sxs-lookup"><span data-stu-id="0b1f2-108">**Response**</span></span>
...
## <a name="see-also"></a><span data-ttu-id="0b1f2-109">Ayrıca bkz.</span><span class="sxs-lookup"><span data-stu-id="0b1f2-109">See also</span></span>

[<span data-ttu-id="0b1f2-110">Başvuran İzleme Sistemi tümleştirme API'si tanıtımı</span><span class="sxs-lookup"><span data-stu-id="0b1f2-110">Applicant Tracking System integration API introduction</span></span>](hr-admin-integration-ats-api-introduction.md)<br>