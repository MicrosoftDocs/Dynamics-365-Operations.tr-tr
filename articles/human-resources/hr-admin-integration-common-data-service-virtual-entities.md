...
description: Bu makalede, mevcut sanal tabloların nasıl yapılandırılacağı, oluşturulacağı, güncelleştirileceği ve Dynamics 365 Human Resources için oluşturulan ve kullanılabilir tabloların nasıl analiz edileceği gösterilmektedir.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
