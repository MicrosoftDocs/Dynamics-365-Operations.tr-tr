...
description: Bu konuda, 26 Temmuz 2021 için Microsoft Dynamics 365 Human Resources'taki yeni veya değişen özellikler açıklanmaktadır.
author: marcelbf
ms.date: 07/12/2021
ms.topic: article
ms.prod: ''
...
| --- | --- | --- |
| Platform update 10.0.20 | -- | [Finance and Operations uygulamalarının 10.0.20 sürümü için platform güncelleştirmeleri (Ağustos 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-20) |
