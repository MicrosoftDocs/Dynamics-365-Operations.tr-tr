...
description: Bu konuda, sabit maaş planı oluşturabilmeniz veya çalışanları kaydedebilmeniz için ayarlamanız gereken bileşenler açıklanmaktadır.
author: twheeloc
ms.date: 08/25/2021
ms.topic: article
ms.prod: ''
