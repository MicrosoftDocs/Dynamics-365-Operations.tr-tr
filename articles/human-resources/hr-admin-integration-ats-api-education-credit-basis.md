...
Fiziksel ad: mshr_hcmeducationcreditbasis

Bu sabit listesi, adayın eğitim kaydının eğitim alacak temeli seçenek kümesini sağlar.

| Değer | Etiket | Tanım |
| --- | --- | --- |
| 200000000 | Boş | Hiçbir değer seçilmedi. |
| 200000001 | Yarı yıl | Yarı yıl. |
| 200000002 | Üç aylık dönem | Çeyrek. |
| 200000003 | Üç aylık süre | Üç aylık dönem. |
| 200000004 | Vade | Dönem. |
| 200000005 | Diğer | Diğer. |
