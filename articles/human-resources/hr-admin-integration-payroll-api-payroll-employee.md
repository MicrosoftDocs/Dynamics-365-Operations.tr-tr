...
description: Bu makalede, Dynamics 365 Human Resources'taki Bordrolu personel varlığıyla ilgili ayrıntılı bilgi ve örnek bir sorgu sağlanmaktadır.
author: jcart
ms.date: 08/25/2021
ms.topic: article
ms.prod: ''
...
Bu makalede, Dynamics 365 Human Resources için Bordrolu personel varlığı açıklanmaktadır.
