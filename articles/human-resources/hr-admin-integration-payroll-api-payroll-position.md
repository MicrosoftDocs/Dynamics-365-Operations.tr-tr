...
description: Bu makalede, Dynamics 365 Human Resources'taki Pozisyonlar varlığı için Bordro ayrıntılarına ilişkin bilgiler ve örnek bir sorgu sağlanmaktadır.
author: jcart
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
Bu makalede, Dynamics 365 Human Resources'daki Bordro Pozisyonları varlığı açıklanmaktadır.
