...
32 platform güncelleştirmesi artık kullanılabilir durumdadır. Daha fazla bilgi için bkz. [Finance and Operations için Platform güncelleştirmesi 32'deki yenilikler veya değişiklikler (Şubat 2020)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-32.md).
