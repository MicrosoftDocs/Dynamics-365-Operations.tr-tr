...
Bu bölümde açıklanan değişiklikler sürüm numarası 8.1.2709 için geçerlidir. Bazı başlıklardaki parantez içindeki numaralar Microsoft Dynamics Lifecycle Services (LCS) destek numaralarına referans verir.
