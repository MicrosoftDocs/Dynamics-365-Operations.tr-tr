...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Dynamics 365 Talent'daki yenilikler veya değişiklikler (12 Kasım 2019)
...
Bu bölümde açıklanan değişiklikler sürüm numarası 8.1.2604 için geçerlidir. Bazı başlıklardaki parantez içindeki numaralar Microsoft Dynamics Lifecycle Services (LCS) destek numaralarına referans verir.

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Ofis konumu Excel çalışma sayfası üzerinden güncelleştirilmiyor (369727)

Bu değişiklikle, artık Office çalışma sayfası tasarımcısını kullanarak ofis konumunu güncelleştirebilirsiniz.
