...
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-september-17-2019"></a>Dynamics 365 for Talent'taki yenilikler veya değişiklikler (17 Eylül 2019)
...
Bu bölümde açıklanan değişiklikler sürüm numarası 8.1.2492 için geçerlidir. Bazı başlıklardaki parantez içindeki numaralar Microsoft Dynamics Lifecycle Services (LCS) destek numaralarına referans verir.
...
### <a name="human-resources-staff-cant-see-performance-review-details-once-assigned-to-them-by-workflow-370308"></a>İnsan Kaynakları personeli, iş akışı tarafından kendilerine atanan performans inceleme ayrıntılarını göremiyor (370308)

Bu haftaki güncelleştirmeyle, İK uzmanları, iş akışı işlemleri aracılığıyla kendilerine atanan performans inceleme ayrıntılarını görebilecek. İncelemeleri görüntülemek için **Personel self servisi > Bana atanan iş öğeleri**'ne gidin.

### <a name="job-family-field-missing-in-the-manage-changes-page-for-job-details-346031"></a>İş ayrıntıları için Değişiklikleri yönet sayfasında iş ailesi alanı eksik (346031)

Bu sürümde, iş ayrıntıları için **Değişiklikleri yönet** sayfasına iş ailesi alanı eklendi.
