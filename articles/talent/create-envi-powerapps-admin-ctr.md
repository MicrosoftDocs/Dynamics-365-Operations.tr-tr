...
# <a name="cant-create-an-environment-in-the-powerapps-admin-center"></a>PowerApps Yönetici merkezinde bir ortam oluşturulamıyor
...
2. [Talent sağlama](https://docs.microsoft.com/en-us/dynamics365/unified-operations/talent/provisioning-talent) içindeki talimatları izleyerek ortamlar oluşturun.
