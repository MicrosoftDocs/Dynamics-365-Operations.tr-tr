...
ms.locfileid: "1704481"
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-june-25-2019"></a>Dynamics 365 for Talent'taki yenilikler veya değişiklikler (Haziran 25 2019)
...
Bu bölümde açıklanan değişiklikler sürüm numarası 8.1.2357 için geçerlidir.

### <a name="incorrect-value-displayed-for-primary-position-314266"></a>Birincil pozisyon için yanlış değer görüntülendi (314266)

Bu değişiklikler, tüm sayfalardaki **Birincil konum** ayarını sürekli olarak görüntüleyecektir.

### <a name="cant-edit-after-recalling-the-workflow-in-review-318180"></a>İncelemede iş akışı geri çağrıldıktan sonra düzenleme yapılamıyor (318180)

İş akışı aracılığıyla geri çağırılmış gözden geçirmeler şimdi düzenlenebilir.

### <a name="final-comments-field-in-reviews-isnt-translated-325921"></a>İncelemelerdeki son açıklamalar alanı çevrilmiyor (325921)

**Son açıklamalar** etiketi Talent'ta çevrilir.
...
### <a name="feature-management-area-in-talent"></a>Talent'ta özellik yönetimi alanı

**Özellik Yönetimi**, özellikle ilgili sorunlar nedeniyle **Sistem yönetiminden** kaldırılacak. Gelecekteki bir sürümde **Özellik yönetimi**'ni yeniden tanıtıyoruz. 

### <a name="common-data-service-entity-support-for-custom-fields"></a>Özel alanlar için Common Data Service varlığı desteği

Aşağıdaki varlıklar özel alanları destekleyecektir: **Bordro kazanç kodu**, **Sabit ücret olayı**, **Ücret kılavuzu**, **Ödeme dönemi** ve **Ücret referans noktası**. 
