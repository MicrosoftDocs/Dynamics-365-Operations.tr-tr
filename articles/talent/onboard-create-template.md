...
## <a name="create-an-onboarding-template-from-an-existing-template"></a>Var olan şablondan ekleme şablonu oluşturma
...
3. Şu adımlardan birini izleyin:
    ...
    [![Var olan şablondan şablon oluşturma](./media/onboard-save-template.png)](./media/onboard-save-template.png)
