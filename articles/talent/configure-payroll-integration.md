...
- [Yeni kazanç oluşturma](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/create-new-benefit)
...
> [!NOTE] 
> Departman gerektiren Pozisyonlar için Talent gerektirebilirsiniz. Bunu yapmak için **İnsan Kaynakları Paylaşılan Pozisyonlar > Pozisyonlar > Pozisyonlarda departmanlar gerektir**'e gidin. Bu ayarın tümleştirme için zorunlu olmasını öneririz.
