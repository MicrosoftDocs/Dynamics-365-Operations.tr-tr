...
### <a name="pdf-renderer-for-candidate-documents"></a>Aday belgeler için PDF Oluşturucu

Attract kullanıcıları şimdi, ekleri indirmek yerine belge görüntüleyicisindeki adayların PDF eklerini görüntüleyebilir.

### <a name="signing-up-for-attract-user-research-group"></a>Attract kullanıcı araştırma grubu için kaydolma 

Yeni ürün yetenekleri veya sevk önizleme özellikleri planlarken, kullanıcılarımızı bizim yönüne bildirmemiz için aradık. İlgilenen kullanıcılar şimdi, uygulamamız üzerindeki kaydolma bağlantısını kullanarak kullanıcı araştırma gruplarımızda yer almak için kaydolmanızı sağlar.
...
Bu sürümde, **İş takvimi** ve **İş takvimi** günü artık Common Data Service'teki özel alanları destekliyor.
