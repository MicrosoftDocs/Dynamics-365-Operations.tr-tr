...
Bu bölümde açıklanan değişiklikler sürüm numarası 8.1.2409 için geçerlidir.
...
### <a name="new-active-positions-list-page"></a>Yeni Etkin pozisyon listesi sayfası

Konum tabanlı listelerin seçenekleri şu anda şunları içerir: **Tüm pozisyonlar**, **Etkin pozisyonlar**, **Açık pozisyonlar** ve **Etkin olmayan pozisyonlar.** Yeni **etkin pozisyonlar** listesi sayfası, yalnızca geçerli tarih itibariyle etkin olan, açık veya doldurulmuş pozisyonları görüntüler. 

### <a name="allow-course-participants-to-be-added-to-open-courses"></a>Kurs katılımcılarının açık kurslara eklenmesine izin ver

Bu haftanın değişiklikleri, yalnızca doğrudan raporların açık kurslar için kaydedilebileceği bir sorunu düzeltmelidir.
...
**Son açıklamalar** etiketi şimdi gözden geçirme formunda çevrilmiştir.
