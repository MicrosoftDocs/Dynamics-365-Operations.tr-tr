---
title: Barkod maskelerini ayarlama
description: Bu makale, barkod maskesi karakterlerini, barkod maskelerini ve barkod maskelerinin barkodlara nasıl atanacağını açıklamaktadır.
author: BrianShook
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8853724"
---
# <a name="set-up-bar-code-masks"></a>Barkod maskelerini ayarlama

[!include [banner](includes/banner.md)]

Bu makale, barkod maskesi karakterlerini, barkod maskelerini ve barkod maskelerinin barkodlara nasıl atanacağını açıklamaktadır.
