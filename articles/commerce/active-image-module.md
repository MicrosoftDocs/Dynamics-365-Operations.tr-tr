...
description: Bu konu etkin görüntü modüllerini kapsamaktadır ve Microsoft Dynamics 365 Commerce'ün site sayfalarına nasıl ekleneceğini açıklamaktadır.
author: anupamar-ms
ms.date: 07/08/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "6716920"
---
# <a name="active-image-module"></a>Etkin görüntü modülü

[!include [banner](includes/banner.md)]

Bu konu etkin görüntü modüllerini kapsamaktadır ve Microsoft Dynamics 365 Commerce'ün site sayfalarına nasıl ekleneceğini açıklamaktadır.
...
1. **Modül Ekle** iletişim kutusunda **Etkin görüntü** modülünü ve **Tamam**'ı seçin.
