...
1. **Parça seç** iletişim kutusunda, **Ödeme** modülünü seçin.
...
1. **Modülleri seç** iletişim kutusunda **Sevkiyat adresi**, **Teslimat seçenekleri**, **Ödeme bölümü konteyneri** ve **İletişim bilgileri** modüllerini seçin ve **Tamam**'ı seçin.
1. **Ödeme bölümü konteyneri** modülünde, üç nokta (**...**) düğmesini seçin ve **Modül ekle**'yi seçin.
1. **Modülleri seç** iletişim kutusunda **Hediye kartı**, **Bağlılık programı** ve **Ödeme** modüllerini seçin ve **Tamam**'ı seçin. Bu şekilde, tüm ödeme yöntemlerinin bir bölümde birlikte göründüğünden emin olabilirsiniz.
