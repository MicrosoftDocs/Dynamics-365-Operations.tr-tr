...
description: Bu makale, şirketinizin sitelerini uyumlu hale getirmek için Microsoft Dynamics 365 Commerce'un sağladığı uyumluluk kılavuzunun bir genel bakışı.
author: BrianShook
ms.date: 01/08/2020
ms.topic: overview
ms.prod: ''
...
Şirketinizin uyumluluk gereksinimlerini incelemekten ve bu gereksinimlerin standartlarını karşılayan siteleri yazma ve oluşturmayla sorumlu olursunuz. Aşağıdaki makaleler, Commerce geliştirme araçlarını kullanırken nasıl hesaba uyum sağlayacağınıza ilişkin örnekler sağlar.
