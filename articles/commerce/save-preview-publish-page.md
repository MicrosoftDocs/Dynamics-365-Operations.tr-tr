...
description: Bu makalede, Microsoft Dynamics 365 Commerce'te sayfa kaydetme, önizleme ve yayınlama yöntemi açıklanmıştır.
author: josaw1
ms.date: 04/14/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9280227"
---
# <a name="save-preview-and-publish-a-page"></a>Sayfa kaydetme, önizleme ve yayımlama

[!include [banner](includes/banner.md)]

Bu makalede, Microsoft Dynamics 365 Commerce'te sayfa kaydetme, önizleme ve yayınlama yöntemi açıklanmıştır.
