...
description: Bu konu, Microsoft Dynamics 365 Commerce Retail yazılım geliştirme setinden (SDK) Polonya için mali yazıcı tümleştirme örneğinin dağıtılmasına ilişkin yönergeler sağlar.
