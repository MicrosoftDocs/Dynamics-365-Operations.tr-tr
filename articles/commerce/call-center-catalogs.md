...
description: Bu makale Dynamics 365 Commerce'te kataloglar için çağrı merkezine özel işlevler açıklanır.
author: josaw1
ms.date: 05/15/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8884068"
---
# <a name="call-center-catalogs"></a>Çağrı merkezi katalogları

[!include [banner](includes/banner.md)]

Bu makalede Dynamics 365 Commerce'de katalog yetenekleriyle bağlantılı, çağrı merkezine özel işlevler açıklanmaktadır.
