...
description: Bu makalede, Microsoft Dynamics 365 Commerce uygulamasında perakende hareketlerini düzenleyebilmeniz için Microsoft Excel çalışma kitabına nasıl alan ekleneceği açıklanmaktadır.
author: josaw1
ms.date: 11/04/2020
ms.topic: index-page
ms.prod: ''
...
Bu makalede, Microsoft Dynamics 365 Commerce uygulamasında perakende hareketlerini düzenleyebilmeniz için Microsoft Excel çalışma kitabına nasıl alan ekleneceği açıklanmaktadır.
