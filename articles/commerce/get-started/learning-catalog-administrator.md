...
|---------|-------------|--------|--------|
| [Dynamics 365 Commerce Uygulamasını Dağıtma ve Genişletme](/training/paths/deploy-dynamics-365-commerce/) | Bu öğrenme yolu her perakendecinin iş gereksinimleri açısından doğru topolojiyi kullanan başarılı Commerce uygulamaları için Dynamics 365 Commerce ortamlarının nasıl dağıtılacağını ve sağlama sonrası adımların nasıl gerçekleştirileceğini açıklar. | Ücretsiz ve kendi öğrenme temponuza uygun çevrimiçi öğrenme yolu | 5 saat   |
...
| İçerik | Tanım | Biçim | Uzunluk |
|---------|-------------|--------|--------|
| [Dynamics 365 Commerce'te e-ticareti yapılandırma ve bununla çalışma](/training/paths/configure-work-e-commerce/)              | Çevrimiçi kanallar ve Dynamics 365 Commerce e-ticaret sitesi, perakendecilerin markalarının çevrimiçi ortamda görünür olmasını sağlar. |
