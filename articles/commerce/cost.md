...
description: Bu makalede, Dynamics 365 Commerce'teki dağıtılmış sipariş yönetimi (DOM) işlevi için maliyet yapılandırması açıklanmaktadır.
author: josaw1
ms.date: 12/05/2018
ms.topic: index-page
ms.prod: ''
