...
1. **Yeni sayfa parçası** iletişim kutusunda, **Promosyon başlığı** modülünü seçin ve sonra **Sayfa parçası adı** altında bir ad girin (örneğin, **Çapraz kanal başlığı**). Daha sonra **Tamam**'ı seçin.
