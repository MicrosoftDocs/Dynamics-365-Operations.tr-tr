...
description: Bu makalede, Dynamics 365 Supply Chain Management 10.0.18'daki yeni veya değişen özellikler açıklanmaktadır.
author: kamaybac
ms.date: 03/01/2021
ms.topic: article
ms.prod: ''
...
Bu makalede, Microsoft Dynamics 365 Supply Chain Management 10.0.18'deki yeni veya değişen özellikler açıklanmaktadır. Bu sürüm, 10.0.793 derleme numarasına sahiptir ve aşağıdaki gibi kullanıma sunulmuştur:

- **Sürümün önizlemesi:** Mart 2021
- **Sürüm genel kullanılabilirliği (kendi kendine güncelleştirme):** Nisan 2021
- **Sürüm genel kullanılabilirliği (otomatik güncelleştirme):** Mayıs 2021
...
- [Stok Görünürlüğü Eklentisi](../inventory/inventory-visibility.md)
- [Varış yeri maliyeti modülü](../landed-cost/landed-cost-overview.md)
- [Malzeme işleme ekipmanı arabirimi (MHAX)](../warehousing/mhax.md)
- [Planlama Optimizasyonu uygunluk analizi](../master-planning/planning-optimization/planning-optimization-fit-analysis.md)
...
10.0.18'nın parçası olan güncelleştirmelerin her birine dahil edilen hata düzeltmeleri hakkında bilgi için, Lifecycle Services'ta (LCS) oturum açın ve [BB makalesini](https://fix.lcs.dynamics.com/Issue/Details?bugId=561679&dbType=3&qc=13bb1641c1be430ead8b21ae3d4e0f800d5b81c39b3a56e890db1de7ede59e46) görüntüleyin.
