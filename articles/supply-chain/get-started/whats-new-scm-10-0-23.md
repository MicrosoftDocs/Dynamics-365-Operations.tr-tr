...
Bu konuda, Microsoft Dynamics 365 Supply Chain Management önizleme sürümü 10.0.23'deki yeni veya değişen özellikler listelenmektedir. Bu sürüm, 10.0.1037 derleme numarasına sahiptir ve aşağıdaki gibi kullanıma sunulmuştur:
...
| Satış ve pazarlama | Satış siparişi güncelleştirme geçmişini temizle | Bu özellik, satış siparişi güncelleştirmeleri ile ilgili geçici geçmiş kayıtları temizlemenizi sağlar. Satış siparişleri için ayrıntı ve liste sayfalarının eylem bölmesine **Satış güncelleme geçmişini temizle** adlı yeni bir düğme ekler. |
