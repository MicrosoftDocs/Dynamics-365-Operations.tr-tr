...
description: Bu makalede, Supply Chain Management'ın tedarik işlevleri hakkında sık sorulan soruların (SSS) yanıtları sağlanmaktadır
...
ms.locfileid: "8869589"
---
# <a name="procurement-faq"></a>Tedarik ile ilgili SSS

[!include [banner](../includes/banner.md)]

Bu makalede, Supply Chain Management'ın tedarik işlevleri hakkında sık sorulan soruların (SSS) yanıtları sağlanmaktadır.
