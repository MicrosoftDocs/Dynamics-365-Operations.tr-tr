...
Aşağıdaki çizimde, (a) ürün H ve parçalar F ve G için ürün reçetesidir, ve (b), ürünler H ve parça F için rota tablosudur.

![İki düzeyde bir ürün reçetesi yapısı örneği.](media/product-H-part-F.png)
...
![H ürününün Mühendislik ürün reçetesi.](media/product-H-part-B.png)
...
![Çok düzeyli ürün reçetesi yapılarında kullanılan hayali satır türü.](media/product-G-route-sheet-G.png)
...
![Çok düzeyli bir ürün reçetesinde kullanılan bir rota ağı örneği.](media/product-G-part-F.png)

Aşağıdaki çizimde, (a) ürün G ve parça F ve G için ürün reçetesidir, ve (b), ürün G ve parça F için rota tablosudur.

![G ürünü ve F parçası için ürün reçetesi ve G ürünü ve F parçası için rota tablosu.](media/product-G-part-F-with-route-sheet.png)
