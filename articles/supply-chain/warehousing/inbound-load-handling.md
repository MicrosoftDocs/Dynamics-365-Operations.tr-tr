...
| Yalnızca kapalı yükler için engelle | Çalışanlar açık yükler için fazla yük satırı miktarları alabilir, ancak _Alındı_durumunda olan yüklemeler için bunu yapamaz. |
...
- Yük ile ilişkilendirilen satınalma siparişinin durumu _Onaylandı_olmalıdır.
...
Ek kayıtlı yük miktarlarını durumu _Teslim alındı_olan bir yüke karşı ürün girişiyle deftere nakletmek için kullanıcının ilişkili satınalma siparişinden deftere nakil eylemini çalıştırması gerekir.
