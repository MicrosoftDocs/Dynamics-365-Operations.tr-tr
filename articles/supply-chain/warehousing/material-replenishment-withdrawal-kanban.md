...
description: Bu makale, çekme kanbanının malzeme stok yenileme ve üretim etkinlikleri için nasıl kullanılacağını açıklar.
author: perlynne
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863722"
---
# <a name="replenishment-with-withdrawal-kanbans"></a>Çekme kanbanlarıyla stok yenileme

[!include [banner](../includes/banner.md)]

Bu makale, çekme kanbanının malzeme stok yenileme ve üretim etkinlikleri için nasıl kullanılacağını açıklar.
