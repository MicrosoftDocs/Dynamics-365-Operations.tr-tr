...
description: Bu makale, dalga tahsisatı adımının nasıl ayarlanacağını açıklar (paralel işlemenin nasıl etkinleştirileceği dahil).
author: Mirzaab
ms.date: 03/08/2021
ms.topic: article
ms.prod: ''
