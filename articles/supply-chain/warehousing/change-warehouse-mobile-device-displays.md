...
ms.locfileid: "859771"
---
# <a name="warehouse-mobile-device-display-settings"></a>Ambar mobil cihaz görüntüleme ayarları

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Bu özellik kullanımdan kalkmıştır. Daha fazla bilgi için bkz. [Kaldırılan veya artık kullanılmayan özellikler](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
