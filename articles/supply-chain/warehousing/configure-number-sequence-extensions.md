...
description: Bu makale plaka kodları, dalga etiketi kodları, konteyner kodları ve konşimento kodları için numara serisi uzantıları sağlayan işlevlere genel bir bakış sağlar.
author: Mirzaab
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
