...
> [!NOTE]
> Bu konuda, eski ambar uygulamasının nasıl yapılandırılacağı açıklanmaktadır. Yeni Ambar Yönetimi mobil uygulamasını (şu anda genel önizleme modunda) yapılandırma hakkında bilgi arıyorsanız [Ambar Yönetimi mobil uygulamasını yükleme ve bağlama](install-configure-warehouse-management-app.md) konusuna bakın.
