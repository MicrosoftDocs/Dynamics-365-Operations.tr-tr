...
description: Bu makalede, varış yeri maliyeti modülü için kullanılabilen çeşitli rapor türlerinin nasıl bulunacağı ve kullanılacağı açıklanmaktadır.
author: Weijiesa
ms.date: 02/01/2021
ms.topic: article
ms.prod: ''
