...
description: Bu konu, paylaştırma yönteminin seçilmesi aracılığıyla maliyet değerinin maliyet alanı içerikleri arasında bölünmesine olanak tanıyan maliyet hareketi varlıkları hakkında bilgi sağlar.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
