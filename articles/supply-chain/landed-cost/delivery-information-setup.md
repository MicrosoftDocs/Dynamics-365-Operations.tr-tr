...
description: Bu makalede, Varış yeri maliyeti modülü için teslimat bilgilerinin nasıl ayarlanacağı açıklanmaktadır.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895626"
---
# <a name="delivery-information-setup"></a>Teslimat bilgileri ayarı

[!include [banner](../../includes/banner.md)]

Bu makalede, **Varış yeri maliyeti** modülü için teslimat bilgilerinin nasıl ayarlanacağı açıklanmaktadır.
