...
## <a name="turn-on-the-inventory-value-report-storage-feature"></a>Stok değeri raporu depolama özelliğini etkinleştirme

Standart **Stok değeri** raporu varsayılan olarak etkindir. Ancak daha gelişmiş **Stok değeri raporu depolama** raporu oluşturabilmek için önce sisteminizde özelliği etkinleştirmelisiniz. Yöneticiler özellik durumunu denetlemek ve gerekirse etkinleştirmek için [özellik yönetimi](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) ayarlarını kullanabilir. **Özellik yönetimi** çalışma alanındabu özellik aşağıdaki şekilde listelenir:
