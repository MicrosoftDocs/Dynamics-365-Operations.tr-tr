...
description: Bu makalede, standart maliyet dönüştürme yapmadan önce gerçekleştirilecek görevler açıklanmaktadır.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Bu makalede, standart maliyet dönüştürme yapmadan önce gerçekleştirilecek görevler açıklanmaktadır. 
