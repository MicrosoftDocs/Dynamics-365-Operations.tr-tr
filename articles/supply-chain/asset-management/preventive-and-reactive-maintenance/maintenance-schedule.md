...
description: Bu makalede Varlık Yönetimi'nde bakım zamanlaması açıklanmaktadır.
...
1. **Varlık yönetimi** > **Bakım zamanlaması** > **Tüm bakım zamanlamaları** veya **Bakım zamanlaması satırlarını aç** veya **Bakım zamanlaması havuzlarını aç** öğesine tıklayın.
