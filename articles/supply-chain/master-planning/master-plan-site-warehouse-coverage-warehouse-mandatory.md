...
description: Bu makale, site ve ambarın kapsam olduğu bir maddenin nasıl planlanacağını anlatır. Ambar boyutu zorunludur.
author: t-benebo
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Bu makale, site ve ambarın kapsam olduğu bir maddenin nasıl planlanacağını anlatır. Ambar boyutu zorunludur.
