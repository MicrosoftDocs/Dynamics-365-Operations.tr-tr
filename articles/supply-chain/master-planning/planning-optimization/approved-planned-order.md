...
description: Bu makale, planlama optimizasyonunda planlı siparişlerin nasıl görüntüleneceği, yönetileceği ve onaylanacağı hakkında bilgi sağlar.
author: t-benebo
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8887442"
---
# <a name="view-manage-and-approve-planned-orders"></a>Planlı siparişleri görüntüleme, yönetme ve onaylama

[!include [banner](../../includes/banner.md)]

Bu makale, planlama optimizasyonunda planlı siparişlerin nasıl görüntüleneceği, yönetileceği ve onaylanacağı hakkında bilgi sağlar.
