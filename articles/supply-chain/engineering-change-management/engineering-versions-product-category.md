...
description: Bu makale, mühendislik sürümleri konsepti hakkında bilgi sağlar. Mühendislik sürümleri, bir ürünün farklı durumlarının ve verilerinin güncel ve net tutulmasını ve sistemde görselleştirilebilmesini sağlar.
author: t-benebo
ms.date: 04/07/2022
ms.topic: article
ms.prod: ''
