...
description: Bu makale, Stok Yönetimi'nde giden işlemine genel bakış sağlar.
author: yufeihuang
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8852490"
---
# <a name="outbound-process-overview"></a>Giden işleme genel bakış

[!include [banner](../includes/banner.md)]

Bu makale, Stok Yönetimi'nde giden işlemine genel bakış sağlar.
