...
Bazı çalışma alanları panonuzda da görmek isteyebileceğiniz sayı kutucukları (içlerinde sayı bulunan kutucuklar) içerir. Çalışma alanında bir sayı kutucuğuna sağ tıklayın, **Kişiselleştir**'i ve ardından **Panoya Sabitle**'yi seçin. Seçilen panoya bir dahaki gidişinizde (ve panoyu yenileyişinizde), o sayıyı panoda çalışma alanının gezinti kutucuğunun altında göreceksiniz.

## <a name="explicit-personalization-personalizing-your-dashboard"></a>Açık kişiselleştirme: Panonuzu kişiselleştirme
Pano genellikle Finance and Operations'ı açtığınızda göreceğiniz ilk sayfadır. Panonuzu çalışma alanı gezinti kutucuklarını yeniden adlandıracak, sadece görmek istediğinizi kutucukları gösterecek, kutucukları yeniden adlandıracak veya kutucukları görmek istediğiniz sırada düzenleyecek şekilde kişiselleştirebilirsiniz. 

Panoyu kişiselleştirmek için herhangi bir kutucuğu seçin ve bağlam menüsünü açmak için sağ tıklayın. Bağlam menüsünde **Kişiselleştir** öğesini seçin. Seçilen kutucuk gizlemek ya da yeniden adlandırmak veya atlamak istediğiniz bir kutucuksa, bu değişikliği beliren Özellik penceresinde doğrudan yapabilirsiniz. Kutucukları düzenlemek istiyorsanız, Kişiselleştirme araç çubuğunu açmak için Özellik penceresinde **Bu formu kişiselleştir** öğesini seçin. Daha sonra kutucukları düzenlemek için **Taşı** Aracını kullanabilirsiniz.

## <a name="administration-of-personalization"></a>Kişiselleştirme yönetimi
Bir sayfayı kişiselleştirdikten sonra, kişiselleştirilmiş sayfayı dışa aktararak kişiselleştirmelerinizi diğer kullanıcılarla paylaşabilirsiniz. Daha sonra diğer kullanıcılardan kişiselleştirilmiş sayfaya gitmelerini ve oluşturduğunuz kişiselleştirme dosyasını içe aktarmalarını isteyebilir veya kişiselleştirmenizi yönetici ayrıcalıklarına sahip olan ve kişiselleştirme dosyasını bir kerede birden çok kullanıcıya uygulayabilecek olan bir kullanıcıya verebilirsiniz.
...
- **Uygula** – Bir veya birden fazla kullanıcı için bir kişiselleştirmeyi içe aktarabilir veya seçebilirsiniz. Bir veya daha fazla kullanıcıya kişiselleştirme uygulamak için bir rol ve o rol içindeki kullanıcıları seçin. Daha sonra, seçtiğiniz kullanıcılara uygulamak üzere mevcut bir kişiselleştirmeyi belirleyin veya bir kişiselleştirme dosyasını içe aktarın. Kişiselleştirme doğrulanır ve seçilmiş olan kullanıcılara, seçili sayfayı bir sonraki açtıklarında uygulanır.

- **Temizle** – Bir veya birden fazla kullanıcı için sayfa veya çalışma alanı kişiselleştirmelerini temizleyebilirsiniz. Bu sayfanın özelleştirildiği kullanıcıların listesini görmek için bir sayfa seçin. Ardından, bu sayfa için kişiselleştirmelerin silinmiş olması gereken kullanıcıları ve **Temizle**'yi seçin. Seçili sayfa veya çalışma alanına seçilen kullanıcılara uygulanan tüm kişiselleştirmeler temizlenir. Bu eylem geri alınamaz. Ancak, sayfa veya çalışma alanı kaydedilmiş bir kişiselleştirmeye sahipse, kişiselleştirme yeniden içeri aktarılabilir.

- **Kullanıcı başına yönetici** – Bu kişi için kişiselleştirilmiş sayfaların listesini görmek için bir kullanıcı seçin.  Daha sonra kullanıcıların belirli sayfalar veya tüm sistem için kişiselleştirme kullanma yeteneklerini etkinleştirebilir veya devre dışı bırakabilirsiniz.  Ayrıca bu kullanıcı için bir kişiselleştirmeyi içe aktarabilir, dışa aktarabilir veya temizleyebilirsiniz.

- **Sistem:** Tüm kullanıcılar için tüm kişiselleştirmeleri geçici olarak devre dışı bırakabilirsiniz. Bunu yaptığınızda kişiselleştirmeleri silmez ancak tüm sayfaları tüm kullanıcılar için varsayılan durumlarına sıfırlarsınız. Kişiselleştirmeyi daha sonra yeniden etkinleştirirseniz, tüm kişiselleştirmeler yeniden uygulanır. Ayrıca sistemdeki tüm kullanıcılar için tüm kişiselleştirmeleri kalıcı olarak silebilirsiniz. Silinen kişiselleştirmeleri daha sonradan kurtarma olanağınız olmadığından bu adımı gerçekleştirmeden önce daha sonra kullanmak isteyebileceğiniz tüm kişiselleştirmeleri dışa aktarın. 
