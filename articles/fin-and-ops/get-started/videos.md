...
# <a name="videos-for-dynamics-365-for-finance-and-operations"></a>Dynamics 365 for Finance and Operations için videolar

[!include [banner](../includes/banner.md)]

Bu sayfa Dynamics 365 for Finance and Operations için Microsoft tarafından oluşturulan ve YouTube ve diğer sitelerde yayınlanan "nasıl yapılır" ve Teknik konuşmalar videolarını listeler.

## <a name="dynamics-365-youtube-channel"></a>Dynamics 365 YouTube kanalı
[Microsoft Dynamics 365 YouTube kanalında](https://www.youtube.com/channel/UCJGCg4rB3QSs8y_1FquelBQ), Dynamics 365 ürünleri için Microsoft tarafından oluşturulan ve çok çeşitli iş çözümlerini gösteren videolar bulabilirsiniz. Bu bölüm kanalda barındırılan Dynamics 365 for Finance and Operations ile ilgili "nasıl yapılır" videolarını listeler.

Videolar içeriğe göre sıralanmıştır. Bu nedenle tüm video içeriği listesini görmek için aşağıya doğru gidin.  
...
- [Visual Studio Team Services ile Lifecycle Services tümleştirmesi](https://www.youtube.com/watch?v=0QyyyUp1zHQ&t=1s)

#### <a name="explore-the-user-interface"></a>Kullanıcı arabirimini keşfetme
- [Özel alanlar ekleme](https://www.youtube.com/watch?v=gWSGZI9Vtnc)
- [PowerApps katıştırma](https://www.youtube.com/watch?v=x3qyA1bH-NY)
...
[Dynamics 365 için FastTrack Teknik Sohbetleri](https://infopedia.eventbuilder.com/index?landingpageid=92tzhl) müşterilere ve iş ortaklarına onu alanlarına özgü ayrıntılı bilgi sağlayan teknik ayrıntılara ve en iyi uygulamalara odaklanır. Aşağıdaki bölüm akış olarak kullanılabilen ve indirilebilir FastTrack Teknik sohbet kayıtlarını listeler. Sunumların bir PDF kopyasını Teknik Sohbet sitesinden indirebilirsiniz. 

#### <a name="data-management"></a>Veri yönetimi
- [Tüzel kişiliğe kopyalama (DYN383PAL)](https://infopedia.eventbuilder.com/event?eventid=q3h0m7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Veri yönetimi (DYN445PAL2)](https://infopedia.eventbuilder.com/event?eventid=a7n1v0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Yapılandırmaları kullanarak içe aktarma ve dışa aktarma süresini azaltma (DYN315PAL)](https://infopedia.eventbuilder.com/event?eventid=s6v1q3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="demo-data"></a>Tanıtım verileri
- [Tanıtım veri paketleri (DYN443PAL)](https://infopedia.eventbuilder.com/event?eventid=m2r4o6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="deployment"></a>Dağıtım 
- [Şirket içi dağıtım (DYN382PAL2)](https://infopedia.eventbuilder.com/event?eventid=m9i7a2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="develop-and-customize"></a>Geliştirme ve özelleştirme
- [Dynamics 365 for Finance and Operations için Azure Tümleştirme araçları (DYN386PAL)](https://infopedia.eventbuilder.com/event?eventid=l7f2i9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Genişletilebilirlik (DYN384PAL2)](https://infopedia.eventbuilder.com/event?eventid=e0x4q5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Analiz çalışma alanlarını genişletme veya yenilerini oluşturma (DYN321PAL)](https://infopedia.eventbuilder.com/event?eventid=r7z0f5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Performans testi yaklaşımı (DYN449PAL2)](https://infopedia.eventbuilder.com/event?eventid=k6c6g9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Performans testi yaklaşımı (DYN449PAL)](https://infopedia.eventbuilder.com/event?eventid=i1u5m9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
#### <a name="intelligence"></a>Zeka
- [Analizler ve raporlama seçenekleri, yazdırma ve Belge Yönlendirme Aracısı (DYN442PAL)](https://infopedia.eventbuilder.com/event?eventid=r6d9a6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Analitik çalışma alanlarını tanıma (DYN317PAL)](https://infopedia.eventbuilder.com/event?eventid=h6e1a7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="mobile"></a>Mobil
- [Gider ve proje mobil çalışma alanı (DYN379PAL2)](https://infopedia.eventbuilder.com/event?eventid=u0g9h5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Mobil çerçeve (VIR824PAL)](https://infopedia.eventbuilder.com/event?eventid=p2o7n7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="procurement-and-sourcing"></a>Satın alma ve Kaynak Hizmeti
- [Çıkış (DYN332PAL2)](https://infopedia.eventbuilder.com/event?eventid=w5u5q8&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Satıcı işbirliği (DYN327PAL)](https://infopedia.eventbuilder.com/event?eventid=c3e4c0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
- [Bakım (VIR805PAL)](https://infopedia.eventbuilder.com/event?eventid=c2k8k3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="upgrade-and-migration"></a>Yükseltme ve geçiş
...
- [Visual Studio Team Services (VSTS) kurulumu (VIR782PAL)](https://infopedia.eventbuilder.com/event?eventid=g9f8g1&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="warehouse-management"></a>Ambar yönetimi
- [Karma plaka alımına eklemeler (DYN331PAL)](https://infopedia.eventbuilder.com/event?eventid=e0u6t2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Ham madde çekme için stok yenileme isteme (DYN333PAL2)](https://infopedia.eventbuilder.com/event?eventid=i5p9d2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Gelişmiş ambar yönetimini kullanmak için madde ve ambar taşıma işlemi (DYN316PAL)](https://infopedia.eventbuilder.com/event?eventid=w0k4b4&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
