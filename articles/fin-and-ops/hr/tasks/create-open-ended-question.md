...
1. <span data-ttu-id="54922-109">Yeni'ye tıklayın.</span><span class="sxs-lookup"><span data-stu-id="54922-109">Click New.</span></span>
2. <span data-ttu-id="54922-110">İlgili soruları bir araya gruplamak için bir Tür seçin.</span><span class="sxs-lookup"><span data-stu-id="54922-110">Select a Type to group related questions.</span></span>
3. <span data-ttu-id="54922-111">Listede, istenen kaydı bulun ve seçin.</span><span class="sxs-lookup"><span data-stu-id="54922-111">In the list, find and select the desired record.</span></span>
4. <span data-ttu-id="54922-112">Listede, seçili satırdaki bağlantıya tıklayın.</span><span class="sxs-lookup"><span data-stu-id="54922-112">In the list, click the link in the selected row.</span></span>
    * <span data-ttu-id="54922-113">Metin, Tamsayı, Gerçek, Tarih, Saat ve Not giriş türleri açık uçlu sorular için kullanılır.</span><span class="sxs-lookup"><span data-stu-id="54922-113">Input types of Text, Integer, Real, Date, Time, and Note are used for open-ended questions.</span></span>  
5. <span data-ttu-id="54922-114">Giriş türü alanında bir seçenek seçin.</span><span class="sxs-lookup"><span data-stu-id="54922-114">In the Input type field, select an option.</span></span>
    * <span data-ttu-id="54922-115">Açık uçlu bir soruda kullanılmak üzere bir metin veya not giriş türü kullanılır.</span><span class="sxs-lookup"><span data-stu-id="54922-115">An input type of Text or Note is used for an open-ended question.</span></span>  
6. <span data-ttu-id="54922-116">Metin alanına sorunuzu girin.</span><span class="sxs-lookup"><span data-stu-id="54922-116">In the Text field, enter your question.</span></span>
