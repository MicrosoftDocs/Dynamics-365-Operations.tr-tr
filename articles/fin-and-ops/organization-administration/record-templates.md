...
Kayıt şablonları, kayıtları Microsoft Dynamics 365 for Finance and Operations içinde daha hızlı oluşturmaya yardımcı olabilir. Microsoft Dynamics 365 for Finance and Operations'te yalnızca bazı kayıt türleri için kayıt şablonları oluşturabilirsiniz.
