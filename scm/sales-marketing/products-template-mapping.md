...
-   UOM için **Desteklenen ondalık basamak sayısının**, **CDS -\> Hedef** içindeki gereksinimlerinizle eşleştiğinden emin olun. UOM başına farklı değerlere ihtiyaç duyuyorsanız, bu Birim içinden **ValueMap** ile yapılabilir, örneğin [Her biri : 0] ve [Pound : 2].

    -   Şablon değeri varsayılan olarak 0 olur.
