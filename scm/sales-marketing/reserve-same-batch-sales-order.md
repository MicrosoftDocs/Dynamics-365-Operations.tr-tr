---
title: "Rezervasyon bir satış siparişi için aynı toplu işlem"
...
# <a name="reserve-the-same-batch-for-a-sales-order"></a>Rezervasyon bir satış siparişi için aynı toplu işlem
