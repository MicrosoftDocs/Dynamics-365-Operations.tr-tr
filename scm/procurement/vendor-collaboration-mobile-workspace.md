...
<td><a href="/dynamics365/operations/dev-itpro/mobile-apps/mobile-platform">Dynamics 365 for Operations mobil platformu</a></td>
</tr>
<tr class="even">
...
<li><a href="vendor-collaboration-work-customers-dynamics-365-operations.md">Dynamics 365 for Operations'ta müşterilerle çalışmak için satıcı işbirliğini kullanma</a></li>
</ul></td>
</tr>
</tbody>
</table>
...
Sipariş satırı yanıtındaki değişiklikler görüntülenir (satıcı işbirliği web arabirimini kullanarak görebileceğiniz, karşıya yüklenmiş notlar ve ekler dışında).
