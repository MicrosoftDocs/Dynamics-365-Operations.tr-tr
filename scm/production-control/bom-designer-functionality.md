...
<li>İlke ayarlandığında <strong>seçili/etkin veya seçili</strong>, ürün reçetesi veya rota versiyonunu tıklatarak seçebilirsiniz <strong>AĞACI</strong>&gt;<strong>ürün reçetesi versiyonları</strong> veya <strong>yol</strong>&gt;<strong>Rota sürümleri</strong>.</li>
</ul></td>
</tr>
<tr class="even">
<td>Sürüm tarihi</td>
...
Bir veya daha fazla sayıda hayalet görüntü içeren BOM'ları İncelemek veya düzenlemek, için BOM tasarımcısını kullanıyorsanız birinci ürünle bağlantılı rota tipik olarak tüm BOM hiyerarşisini kaplayacak şekilde genişler. Genel basitleştirmek için üst düzey rota görüntüde tıklatarak kilitleyebilirsiniz **Görünüm**&gt;**kilit yol**. Rota kilidini açmak için tıklatın **Görünüm**&gt;**Unlock yol**.

## <a name="adding-and-editing-boms-and-bom-lines"></a>BOM'ların ve BOM satırlarının eklenmesi ve düzenlenmesi
Kullanım ** ürün reçetesi satırlarının ** veya **AĞACI** ürün reçetesi ve ürün reçetesi satırlarını değiştirmek için İşlevler. Ağaç görünümden bir düğüm seçtiğinizde düğümün türü, kullanılabilecek işlevleri belirleyecektir.

| İşlev                            | Açıklama                                                                                               | Düğüm türü ve koşullar                                                                                                                                                                                                                                                                       |
|-------------------------------------|-----------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Ürün reçetesi satırlarını &gt;Düzenle                 | BOM satırı özelliklerini düzenleyebileceğiniz bir iletişim kutusu açın.                                             | Bu işlev bir BOM satır düğümü seçildiğinde kullanılabilir.                                                                                                                                                                                                                                   |
| Ürün reçetesi satırlarını &gt;Sil               | Seçilen BOM'dan bir BOM satırını silin.                                                                  | Bu işlev, bir BOM satır düğümü seçildiğinde ve BOM düzenleme için kilitlenmediğinde kullanılabilir.                                                                                                                                                                                             |
| Ürün reçetesi satırlarını &gt;önce Satır Ekle      | Seçilen BOM satırından önce bir ürün çeşidini seçebileceğiniz bir iletişim kutusunu açın.         | Bu işlev bir BOM satır düğümü seçildiğinde kullanılabilir.                                                                                                                                                                                                                                   |
| Ürün reçetesi satırlarını &gt;ÜR bileşenine ekleme | Seçilen BOM'un sonuna eklemek üzere bir ürün çeşidi seçebileceğiniz bir iletişim kutusunu açın.       | Bu işlev seçilen düğümün bir seçilen BOM içerdiği durumlarda kullanılabilir. Bu işlev kullanılabilir değilse, seçilen ürün çeşidi için bir BOM sürümü eksik olabilir. Bu durumda, tıklatın **AĞACI**&gt;**sürüm oluşturma** eksik sürümü Seçili düğüm için oluşturmak için. |
| Ürün reçetesi satırlarını &gt;sonra satır Ekle       | Seçilen BOM satırından sonra bir ürün çeşidini seçebileceğiniz bir iletişim kutusunu açın.          | Bu işlev bir BOM satır düğümü seçildiğinde kullanılabilir.                                                                                                                                                                                                                                   |
| Ürün reçetesi &gt;sürüm oluşturma             | Seçili düğümün ürün çeşidi için yeni bir BOM sürümü veya BOM oluşturun.                             | Bu işlev, seçilen BOM satır düğümünün **BOM** veya **Formül** türünde bir üretime sahip olan bir ürünle ilişkilendirilmesi durumunda kullanılabilir.                                                                                                                                                  |
...
| Ürün reçetesi &gt;kontrol edin                      | Seçili BOM'u doğrulayın ve kontrol edin.                                                                      | Bu işlev seçilen düğümün bir BOM sürümüyle ilişkili olduğu durumlarda kullanılabilir.                                                                                                                                                                                                         |
