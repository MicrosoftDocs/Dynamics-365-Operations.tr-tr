...
Aşağıdaki senaryoda, mali olarak güncelleştirilmiş giriş ve çıkış deftere nakledilmiştir. Stok kapanışı sırasında, sistem girişi doğrudan çıkışa karşılık kapatır ve çıkışta maliyet fiyatı için bir ayarlama yapılması gerekmez. Aşağıdaki çizimde bu hareketler gösterilmiştir:
...
Sistem 1. gün için doğrudan kapatma yaklaşımını kullanır. **2. Gün:**
...
Sistem 2. gün için doğrudan kapatma yaklaşımını kullanır. **3. Gün:**
