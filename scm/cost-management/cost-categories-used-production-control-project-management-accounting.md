...
Bazı üretim iş türleri, proje süresi tahminlerine ve raporlamaya uygulanabilir. Bu durumda, üretim ve proje amaçları için bir maliyet kategorisi gereklidir. Bir maliyet kategorisinin üretim ve proje içinde kullanıldığında, projeyle ilgili ek bilgi tanımlanmalıdır. Örneğin, projelerle ilişkilendirilmiş olan saatlik maliyetler üretimle ilişkilendirilmiş olan saatlik maliyetlerden farklıdır. **Maliyet kategorileri** sayfasını kullanarak Üretim kontrol ve Proje yönetim muhasebesinde kullanılan bir maliyet kategorisi tanımlayabilirsiniz. **Not:** Maliyet muhasebesinde bir **Proje kategorileri** sayfası vardır ama bu sayfanın bu konuda açıklanan işlevle ilişkisi yoktur. Projelerde bir maliyet kategorisi kullandığınızda **Maliyet kategorileri** sayfasında proje ile ilgili ek bilgiler gösteren ek sekmeler olur. Bu bilgiler, maliyet kategorisine atanmış kategori grubu, bir satır özelliğini ve genel muhasebe hesaplarını içerir.
