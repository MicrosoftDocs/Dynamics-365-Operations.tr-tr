---
title: "Üretilen veya temin ürünler ayarlama"
description: "Ürünleri çeşitli şekillerde kaynaklanan - bunlar (mamul) üretilen veya temin (satın alınan). Bu makalede birden fazla kaynak kullanımının desteklenmesi için ürünlerin nasıl yapılandırılacağı ile ilgili bazı genel hususlar açıklanmıştır."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>Üretilen veya temin ürünler ayarlama

Ürünleri çeşitli şekillerde kaynaklanan - bunlar (mamul) üretilen veya temin (satın alınan). Bu makalede birden fazla kaynak kullanımının desteklenmesi için ürünlerin nasıl yapılandırılacağı ile ilgili bazı genel hususlar açıklanmıştır. 
