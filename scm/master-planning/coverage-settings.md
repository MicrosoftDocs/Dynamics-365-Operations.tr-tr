...
-   Boyut grubu için kapsam ayarları belirtin. ' I **ürün bilgi yönetimi &gt;ortak &gt;ürünleri piyasaya**. Üzerinde ** Ürün Ayrıntıları Serbest ** sayfa üzerinde **genel** No **Yönetim** tıklatın, grup **depolama boyut grubu** bağlantı. **Depolama boyut grubu** sayfasında **Boyuta göre kapsam planı** alanını seçerek depolama boyut grubundaki bir boyut için kapsam ayarları oluşturabilirsiniz. Yapılandırma, renk, boyut, stil, tüm ürün boyutlarında olmalıdır **boyuta göre tedarik planı** alanı seçili.
