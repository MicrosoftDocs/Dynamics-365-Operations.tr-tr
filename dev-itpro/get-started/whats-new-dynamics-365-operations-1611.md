...
| Hedef şablonları oluşturun ve bunları yeni hedefler eklemek için kullanın.                                          | Şirketteki pek çok personel tarafından paylaşılan hedefler için hedef şablonları oluşturabilirsiniz. Personel bir şablondan kendi hedeflerini ekleyebilir, yöneticiler ekipleri için bir şablondan hedef ekleyebilir ve İK ekibi üyeleri de şirketteki personel için hedefler ekleyebilir.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| İnsan kaynakları için beş yeni güç BI içerik paketleri erişim                                     | Yeni içerik paketleri aşağıdaki analiz etmek İnsan Kaynakları kuruluş ve İnsan Kaynakları yöneticilerini etkinleştir: yaş, cinsiyet ve Medeni durum • işgücü ölçümleri • demografik dökümleri karşılaştırmak attrition oranları yıl yıl üzerinden ve çalışanlara verilen kuruluş • görünüm listesi kapalı açık pozisyonları maaş karşılaştırması yanı sıra açık pozisyonları ve faydaları • karşılaştırma saatlik bırakmak için nedenler listesini görmek ve maaşlı çalışanlar • kullanılabilir faydaları • View çalışanların kayıtlı çalışan sayısını görüntüleyin Başvuranlar Başvuranlar, nerede bunlar geldiği, ve bunlar uyguladığınız durumu • çalışanların listesi tarafından konumu • Couse katılımcı tarafından kuruluş Eğitim • kursu kayıt için pozisyonlar için kurslar çalışan yetkinlikleri ve geliştirme • beceri listesini kayıtlı sayısına dayalı İstihdam tipi işe alma • Analyze tarafından tutulan çalışanlar • takım üyesi tarafından yetenek tiplerini dökümü tarafından |
...
<td>Banka LC sair Suudi Arabistan ayırma biçimini giderleri</td>
</tr>
<tr class="odd">
...
| Yapabilecekleriniz                                                                                                                                                                                                                                                                        | Bunun önemi                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| (Hangi müşteri ilgileniyorsanız onların satın alma geçmişi, kendi istek listesindeki öğeleri ve diğer müşteriler ve çevrimiçi satın maddeler Tuğla Dibek depolarında göre belirlemek için satış noktası POS) üzerinde birden çok touchpoints at kişiselleştirilmiş ürün önerileri görüntüleme | Perakendeciler ile büyük kataloglar için kişiselleştirilmiş öneriler müşteri ürün bulma ile Yardım ve mağaza associates ile akıllı clienteling kuşanın. Bir müşterinin ilgi ve satın alma alışkanlıkları hedeflenen vitrini ürünleri ürün önerileri Perakendeciler ile satın yardımcı olabilir ve müşteri tutma geliştirebilirsiniz. Dynamics 365 - işlemleri için perakende, ürün önerileri kavrama Hizmetleri ve Microsoft Azure makine öğrenme tarafından güç sağlar. |
...
| Dynamics 365 for Operations'da konsinye desteği hakkında daha fazla bilgi edinin                                                                                                         | Konsinye işlemler için destek hakkında daha fazla bilgi için bkz: [konsinye](/dynamics365/operations/scm/inventory/consignment), [konsinye ayarlama](/dynamics365/operations/scm/inventory/set-up-consignment), [konsinye stok yenileme emri (görev Kılavuzu) oluşturmak](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), ve [üretim talep (görev Kılavuzu) göre konsinye stok sahipliğini değiştirmek](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
<tbody>
<tr class="odd">
<td>Talebin nereden kaynaklanacağını ve nasıl bulunacağını doğrudan satış siparişi satırlarından tanımlayın. <strong>Örnek</strong> bir satış siparişi satırı oluşturun ve doğrudan teslim teslimat tipi belirtin. Birincil satıcı, satış siparişi satırına kaynak noktası olarak eklenir.</td>
...
<tr class="even">
<td>Sipariş taahhüdünü doğrudan satış siparişi satırlarından oluşturun. <strong>Örnek</strong> şirketlerarası satıcı kaynaklanacağı bir satış siparişi satırı oluşturun. Satırdan çıkın. Teslimat tarihleri, kaynak sağlayan şirketteki kullanılabilirliğe göre hesaplanır.</td>
