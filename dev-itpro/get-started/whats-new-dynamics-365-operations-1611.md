...
| Dynamics 365 for Operations'da konsinye desteği hakkında daha fazla bilgi edinin                                                                                                         | Konsinye işlemleri desteği hakkında daha fazla bilgi için bkz. [Konsinye](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Konsinyeyi ayarlama](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Konsinye stok yenileme siparişi oluşturma (Görev kılavuzu)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) ve [Üretim talebine bağlı olarak konsinye stok sahipliğini değiştirme (Görev kılavuzu)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
