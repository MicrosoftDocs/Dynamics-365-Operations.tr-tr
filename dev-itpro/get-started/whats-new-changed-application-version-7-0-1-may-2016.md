...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Ne yapabilirsiniz?**                                                | **Bu neden önemlidir?**                                                                                                                                                                                                                                                                                         |
| Finansal raporlama veri reyonunu yeniden oluşturun.                          | Dynamics AX veritabanları ortamlar arasında taşıdığınızda veya diğer ortama bozucu değişiklik finansal raporlama veritabanının yeniden oluşturulması gerekebilir. Windows PowerShell komut dosyası, şimdi veritabanını derlemekte sağlanır.                                                                |
| Artık geçerli olmayan rapor tasarımcısı seçeneklerini belirleyemezsiniz. | Yönetim raporlayıcısının pazar içi sürümlerinde kullanılan pek çok rapor tasarımcısı seçeneği Dynamics AX'in bu sürümünde geçerli değildir. Bu seçenekler, finansal rapor tasarımı, çıktı ve bağlama ile ilgili. Bu seçenekler, kullanıcı hataları önlemek için mali Rapor Tasarımcısı'ndan kaldırılmıştır. |
