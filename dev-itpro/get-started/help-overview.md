...
Görev Kaydedici hakkında daha fazla bilgi için bkz. [Finance and Operations'da görev kaydedici.](../user-interface/task-recorder.md).
...
--------
[Finance and Operations yardım sistemi (indirilebilir bilgi notu)](https://mbs.microsoft.com/files/public/CS/AX2012R3/DynamicsAXHelpSystemFactSheet.pdf)
