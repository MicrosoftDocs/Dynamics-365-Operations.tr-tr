...
Aşağıdaki örnekler şunu gösterir:
...
<li>Bu işlevin parametresi olarak model numaralandırma kullanmak için tasarlanan ER ifadesi <strong>$IsArrivals</strong>. Bu ifadenin değeri <strong>DOĞRU</strong>'dur</li></ul></td>
</tr>
</tbody>
</table>
