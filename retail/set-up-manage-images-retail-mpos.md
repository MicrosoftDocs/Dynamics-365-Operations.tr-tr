---
title: "Kurma ve perakende için Modern POS görüntüleri yönetme"
description: "Bu makalede, kurma ve yönetme perakende Modern POS (MPOS içinde) görünen çeşitli varlıklar için görüntüleri katılan adımları açıklar."
author: MargoC
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-and-manage-images-for-retail-modern-pos"></a>Kurma ve perakende için Modern POS görüntüleri yönetme

Bu makalede, kurma ve yönetme perakende Modern POS (MPOS içinde) görünen çeşitli varlıklar için görüntüleri katılan adımları açıklar.
...
9.  Kanal tarafında katalog görüntülerde medya şablonunu güncelleştirmek için çalıştırdığınızdan emin olun **katalog işi 1150** gelen **perakende BT**&gt;**dağıtım zamanlamasını**. [![catalog1](./media/catalog1.png)](./media/catalog1.png)

## <a name="previewing-an-image-from-the-entity-level"></a>Varlık düzeyinde Görüntü Önizleme
1.  HQ'da varlık öğesi sayfasından medya şablondan türetilen resim URL'si kullanan resmi önizleyebilirsiniz. Bu örnek için uygun Kataloğu'na gidin ve ardından eylem bölmesinde, **Media**&gt;**görüntüleri**. Farklı kanal profilleri olabilecek farklı mağazalar seçmek için açılır listeyi kullanın.
...
Tüm beş desteklenen varlıklar için (çalışan, müşteri, katalog, kategori ve ürün) güncelleştirmek ne zaman **tanımla medya şablon** görüntüyü oluşturan ayarlamak için gelen katalog işi (1150) çalıştırmak emin olun iletişim **perakende BT**&gt;**dağıtım zamanlamasını**. Bu işi kanala eşitlenmiş ve MPOS tarafından kullanılan güncelleştirilmiş medya şablonu etkinleştirir. Aşağıdaki değişiklikleri yaptıktan sonra katalog işini (1150) çalıştır:

-   Katalog görüntü medya şablonundan güncelleştirme **katalog resimleri**&gt;**tanımla medya şablon**.
-   Çalışan resmi medya şablonundan güncelleştirme **çalışan görüntüleri**&gt;**tanımla medya şablon**.
-   Müşteri resmi medya şablonundan güncelleştirme **Müşteri resmi**&gt;**tanımla medya şablon**.
-   Ürün resmi medya şablonundan güncelleştirme **ürün resimleri**&gt;**tanımla medya şablon**.
-   Kategori görüntü medya şablonundan güncelleştirme **kategori resimleri**&gt;**tanımla medya şablon**. Ayrıca kanal yayımlamanız gerekir.
...
7.  İstendiğinde, sağ bölmede **bu eklentiye güven**'e tıklayın ve eklenti yükleme tamamlamasını bekleyin. [![Bu eklenti, güven](./media/excel4.jpg)](./media/excel4.jpg)
8.  Oturum açmanız istendiğinde, HQ için oturum açmak amacıyla kullandığınız kimlik bilgilerini girin. [![İstemi açma](./media/excel5.png)](./media/excel5.png)
...
11. Ürünler dışındaki tüm varlıklar için resim URL'leri üzerine yazabilirsiniz. Varolan resim URL'sini, resmin yeni hedef URL'sini kullanacak şekilde değiştirin ve dosya adını resim dosyası için yeni dosya adıyla güncelleştirin. Dosya adının kaydın benzersiz sağlanmasına yardımcı olmak için benzersiz olması gerekir. [![Excel'de resim URL'leri üzerine](./media/excel6.jpg)](./media/excel6.jpg)**Not:** Excel işlevlerini veya varlık madde sayfa düzenleme kullanarak resim URL'leri ürünleri varlıklar için üzerine yazdığınızda, MPOS ortam üzerine resim URL'leri ile birlikte şablon görüntü URL'leri her zaman gösterir..
...
1.  ' I **katalog**&gt;**Media**&gt;**görüntüleri**ve güncelleştirmek için katalog resmi seçin.
...
4.  **Tamam** düğmesine tıklayın. Resim URL'si için bu katalog görüntü güncelleştirilir ve önizlemesi gösterilir. [![preview3](./media/preview3.png)](./media/preview3.png)
...
**[![cat3](./media/cat3.png)](./media/cat3.png)Not:** kategori görüntü ilişkilendirme sonrasında gerekir kanal yayımlarsanız ve değişiklikleri kanal veritabanına yayımlanan sağlanmasına yardımcı olmak için kanal işini çalıştırın.
...
1.  ' I **ürün bilgi yönetimi**&gt;**ürünleri**&gt;**ürünleri**.
...
7.  MPOS çevrimdışı moduna geçirin. HQ belirli ürün için karşıya görüntü görmelisiniz. [![offline1](./media/offline1.png)](./media/offline1.png)
...
1.  Kataloğu'na gidin ve ardından eylem bölmesinde tıklatın **Media**&gt;**görüntüleri**.
