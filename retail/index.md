...
## <a name="workforce-management"></a>İş gücü yönetimi
Perakendeciler, marjların düştüğü bir ortamda karlı olmak için sürekli olarak işletme maliyetlerini azaltmaya çalışır. Çoğu perakendeci için, perakende personelinin maliyeti işletme maliyetinin önemli bir parçasıdır. Bu nedenle, perakendeciler bu maliyeti kontrol ederek sonuçlarında önemli bir etkiye sahip olabilir. Ayrıca, güçlü ve üretken bir iş gücü kendini daha iyi müşteri deneyimine adar.

Retail, mağaza yöneticilerinin mağazalardaki çalışanlar için vardiyalar ve programlar oluşturup yayınlamasını, vardiyalara yönerge eklemelerini ve önceki haftadan geçerli haftaya programlar kopyalamalarını sağlar. Ayrıca, yöneticiler perakende çalışanlarının gönderdikleri izin isteklerini görebilir ve bu istekleri onaylayabilir ya da reddedebilir. Aynı zamanda, "vardiya değiştirme" ve "vardiya teklifi" isteklerini de görerek bu istekleri onaylayabilir veya reddedebilir.

Mağaza yetkilileri, vardiyalara ilişkin yönergelerle birlikte vardiyalar ve atanan programlar ile vardiyalara atanan birlikte çalışanları görebilir. Aynı zamanda, izin istekleri, iş arkadaşlarıyla vardiya değiştirme istekleri ve vardiya teklifi istekleri de gönderebilirler.
...
- [Geliştiriciler ve BT Uzmanları için Microsoft Dynamics 365 for Retail](/dynamics365/unified-operations/dev-itpro/dev-tools/developer-home-page)

## <a name="additional-resources"></a>Ek kaynaklar
### <a name="whats-new-and-in-development"></a>Geliştirmedeki yenilikler
Yayınlanmış ve geliştirilmekte olan yeni özellikleri görmek için [Microsoft Dynamics 365 Yol Haritası](https://roadmap.dynamics.com/) bölümüne gidin.
