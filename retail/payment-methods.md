...
description: "Sistem kurulduğunda bir satıcıya kabul eden her ödeme tipi perakende ve ticaret işlemleri için Microsoft Dynamics 365 yapılandırılması gerekir. Bu makale, ayarlayabileceğiniz ödeme türlerini ve bunları ayarlamak için gerekli işlemi açıklamaktadır."
author: MargoC
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Sistem kurulduğunda bir satıcıya kabul eden her ödeme tipi perakende ve ticaret işlemleri için Microsoft Dynamics 365 yapılandırılması gerekir. Bu makale, ayarlayabileceğiniz ödeme türlerini ve bunları ayarlamak için gerekli işlemi açıklamaktadır.

Perakendeciler, sattıkları ürünler ve hizmetler karşılığında çeşitli türlerde ödemeler kabul edebilirler. Nakit, en yaygın ödeme yöntemi olmasına rağmen perakendeciler çek, kart, makbuz vb. şeklinde de ödeme kabul edebilmektedirler. Satıcıya kabul eden her ödeme tipi Dynamics 365 işlemleri - sistem kurulduğunda perakende için yapılandırılmış olması gerekir. Dynamics 365 işlemleri - perakende için ayarlanabilir her ödeme tipi aşağıdaki listede açıklanmaktadır:
...
-   **Bağlılık programı puanları** – müşteri bağlılık programları biriken puan. Bağlılık programları oluşturursanız, müşteri puan kazanırsınız ve sonra onları çeşitli şekillerde kullanma. Örneğin, bazı sadakat programlarında müşteriler, sadakat puanlarını bir indirim olarak ve hatta bir ödeme yöntemi olarak kullanabilmektedirler.
...
2.  Organizasyon kapsamında kart tipleri ve kart numaraları oluşturmak. Kredi kartı veya ATM kartları kabul edilirse, kartları için bir ödeme yöntemi oluşturun ve sonra Organizasyon kapsamında kart tipleri ve kart numaraları oluşturmak.
3.  Mağaza ödeme yöntemi ayarlamak. Ödeme yöntemleri her mağaza ile ilişkilendirmek ve her bir ödeme yöntemi için mağazaya özel ayarları girin.
4.  Mağazalar için kart ödeme yöntemlerini ayarlayın. Mağaza kabul eden tüm kart ödeme yöntemleri için kart kurulumunu tamamlayın.
