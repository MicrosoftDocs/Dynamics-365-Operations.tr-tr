...
description: "Bu makalede açıklanmıştır bir sınıflama ise ve sınıflamalar Microsoft Dynamics 365 işlemleri - perakende olarak ayarlanacağını açıklar."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
