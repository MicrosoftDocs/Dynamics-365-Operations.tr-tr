---
title: "Bir satıcı ödemesi için hesaplanan iskonto&quot;den fazla olan bir indirim alın"
...
# <a name="take-a-discount-that-is-more-than-the-calculated-discount-for-a-vendor-payment"></a>Bir satıcı ödemesi için hesaplanan iskonto'den fazla olan bir indirim alın
...
Satıcı 3051, bir faturanın yedi gün içinde ödenmesi durumunda Fabrikam'a yüzde 4 oranında bir nakit iskontosu veriyor. 29 Haziran tarihinde April, 1.000,00 tutarında bir fatura giriyor. Satıcı, April'in fatura için kullanılabilecek, 40,00 tutarındaki varsayılan iskonto yerine 60.00 tutarında bir iskonto almasına izin veriyor. April, Borç hesapları ödeme günlüğünü kullanarak bir tek seferlik ödeme kaydediyor. Satıcı için ödeme girer ve sonra açılır **kapatma hareketleri** sayfa. Filiz fatura işaretler ve değer değişir **nakit iskontosu tutarı** alanı **60.00**.
