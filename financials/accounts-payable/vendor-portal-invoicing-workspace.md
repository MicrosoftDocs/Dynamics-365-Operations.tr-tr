...
**Satıcı iş birliği faturalama** çalışma alanı, satıcı faturası bilgilerini görüntülemek ve iş akışı özelliklerini kullanarak Microsoft Dynamics 365 for Operations uygulamasına fatura göndermek için kullanılabilir.
Satıcı iş birliği faturalama çalışma alanı
----------------------------------------
...
-   Gönderilen, onaylanmamış faturalar satıcının gönderdiği ancak Dynamics 365 for Operations uygulamasında deftere nakletmediği faturalardır.
-   Onaylanmış, ödenmemiş faturalar Dynamics 365 for Operations uygulamasında deftere nakledilmiş ancak henüz tamamen ödenmemiş faturalardır.
-   Ödenmiş faturalar Dynamics 365 for Operations uygulamasında tamamen ödenmiş faturalardır.
