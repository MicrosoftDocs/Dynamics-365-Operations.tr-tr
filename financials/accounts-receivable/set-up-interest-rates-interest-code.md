...
-   **Yüzde** seçili ** ** içinde **göre vade farkını hesaplamak** alanına **vade farkı kodlarını ayarlamak** sayfa.

Örneğin, her iki hareketin fatura ödeme aştığını ay için yüzde 5 faiz değerlendirip bir vade farkı kodu ayarlamak için son tarih 2'de girersiniz **vade farkını hesaplamak her** seçin ve alan **ay**.
...
-   İsteğe bağlı vade farkı tutar limitleri girilebilir.
-   ** Tutar ** seçilir **göre vade farkını hesaplamak** alanına **vade farkı kodlarını ayarlamak** sayfa.

Örneğin, fatura ödeme hareketi aştığını 20 her gün için 25.00 ilgisini değerlendirip bir vade farkı kodu ayarlamak için son tarih, 20'de girersiniz **vade farkını hesaplamak her** seçin ve alan **gün**.
...
## <a name="example-1-interest-by-range--amount"></a>Örnek 1: Aralığına göre Faiz Tutarı =
...
## <a name="example-2-interest-by-range--days"></a>Örnek 2: Faiz aralığına göre gün =
--------------------------------------------------
...
## <a name="example-3-interest-by-range--months"></a>Örnek 3: Faiz aralığına göre ay =
----------------------------------------------------
