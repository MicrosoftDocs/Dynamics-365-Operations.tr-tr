...
Bir hizmet sağlamak, bir ürün üretmek veya bir sonuç elde etmek için tasarlanmış bir grup etkinliklerinin bir projedir. Proje kaynaklarını tüketebilir ve gelirler veya kıymet formunda finansal sonuçlar üretmek.

## <a name="projects-across-industries"></a>Endüstrilerdeki projeler
Proje yönetimi ve muhasebe işlevi, aşağıdaki şekilde gösterildiği gibi birden fazla endüstride kullanılabilir. [![Endüstriler projeleri](./media/projects-accross-industries.jpg)](./media/projects-accross-industries.jpg) 

Çağrı merkezinde bir bilet, bir çağrının çözülmesi için gerekli eylemlerin tanımlanması için kullanılabilir. Danışmanlık şirketleri Yönetimi veya teknik kuruluşlara danışmanlık ve kurumları, reklam gibi etkinlikler için projeler olarak bakın. Pazarlama, kampanya teslim edilmelidir iş kümesini temsil eder. Projeye dayalı üretimlerde bir üretim emri, hedeflenen nihai ürünlerin üretilmesi için gerçekleştirilmesi gereken çeşitli çalışmaları kapsar. Adı ne olursa olsun onlar için kullanılır, bu projeler kaynakları, çizelgeler ve maliyetleri içeren ve proje yönetimi ve muhasebe işlemleri için Microsoft Dynamics 365 işlevselliğindeki planlama ile yürütme ve bu projelerin analiz yardımcı olabilir.
...
Birkaç anahtar işlemleri proje başlatma sırasında oluşur. Proje teklifi, tahmini işçilik giderleri ve malzemeler için müşteri iletişim kurmak için kullanabilirsiniz. Ödeme Şartları, sınırları ve sözleşmeleri bir proje sözleşmesi kaydedebilirsiniz. Çalışma çözümleme yapısı (ÇÇY), planlama ve iş tahmin etmek için kullanabilirsiniz. Proje yürütmeye yol göstermesi için tahminleri ve bütçeleri ayarlayabilirsiniz. Aşağıdaki resimde bir proje yapısını gösterir. [![Proje yapısı](./media/project-structure1.jpg)](./media/project-structure1.jpg)  
...
Microsoft Dynamics 365 işlemleri için altı proje türlerini oluşturabilirsiniz. Her proje türü farklı maliyetler ve gelirinin tanınması için ayarlanır. Seçtiğiniz proje türü, projenin türüne dayalıdır. Aşağıdaki tabloda her bir proje türünün tipik kullanımı açıklanmıştır.
...
| Sabit fiyat       | Sabit fiyatlı projelerde, fatura hesaba mahsup hareketler oluşur. Bir sabit fiyatlı projeyi bir proje sözleşmesine dayanan bir faturalama zamanlamaya göre faturalanır. Sabit fiyatlı bir proje için gelir, tamamlanan yüzde yöntemi kullanılarak hesaplanabilir ve proje genelinde nakledilebilir. Alternatif olarak gelir, proje tamamlandığında tamamlanan sözleşme yöntemi kullanılarak hesaplanabilir ve proje genelinde nakledilebilir. Şirketler sıklıkla bir projenin veya bir grup projenin tamamlanma derecesini hesaplamak üzere süren iş (WIP) değerinin sunduğu avantajlardan yararlanır.                                                                                                                                     |
| Yatırım        | Yatırım projeleri anlık kazançlar içermeyen projelerdir. Tipik olarak, maliyetlerin mutlaka aktifleştirilmesi gereken, uzun vadeli dahili projeler için kullanılır. Bir yatırım projesi için sadece maddeler, saat ve giderler için yapılan maliyetler kaydedilebilir. Bir Yatırım projesinin maliyeti tahmin işlevi kullanılarak takip ve kontrol edilir. Yatırım projeleri bir opsiyonel maksimum aktifleştirme kullanılarak oluşturulabilir. Bir Yatırım projesi ilerledikçe maliyetlerini WIP hesaplarına kaydedersiniz ve burada maliyetler, proje tamamlanana kadar tutulur. Proje elendiğinde, bir sabit kıymet, bir genel muhasebe hesabına veya yeni bir Proje Süren iş değerini aktarın.
> [!NOTE] 
> Yatırım projelerindeki hareketler üzerinde gösterilen olmayan **Maliyetleri deftere**, **geliri tahakkuk**, veya **fatura teklifleri oluştur** sayfa.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | | Maliyet projesi | Yatırım projeleri gibi maliyet projelerine genellikle dahili projeler ve yalnızca saat, giderleri izlemek için kullanılır ve öğeleri onlar için kaydedilebilir. Ancak, Maliyet projeleri genellikle Yatırım projelerine kıyasla daha kısa sürelidir. Ek olarak, Yatırım projelerinin aksine, Maliyet projeleri, bilanço hesaplarına aktifleştirilemez. Bunun yerine, kendi proje hareketleri yalnızca kar ve zarar hesaplarına nakledilir. 
[!NOTE] 
> Maliyet projelerindeki hareketler yansıtılan olmadığından **Maliyetleri deftere**, **geliri tahakkuk**, veya **fatura teklifleri oluştur** sayfa. Maliyet projelerindeki genellikle iç projeleri izlemek için kullanıldığından, bunlar genellikle bir müşteri hesabı ile ilişkili olması gerekmez. Ancak, kurulumunuz gereği satın alma emirleri için madde gereksinimlerinin oluşturulması gerekiyorsa Maliyet projesini mutlaka bir projeyle ilişkilendirmelisiniz. Bu ilişkilendirme, madde gereksinimlerin satış emri satırları olarak yönetilmesinden ve sistemin bir müşterinin tanımlanmasını gerektirmesinden kaynaklanır. Ancak, bu kurulum, madde gereksinimlerinin otomatik olarak bir satın alma emrinden oluşturulmasına neden olmaz. Maliyet projeleri için **Madde gereksinimi oluştur** ayarı göz ardı edilir. Bir Maliyet projesinde bir madde gereksinimine ihtiyaç duyuyorsanız, projeyle bir müşterinin ilişkilendirilmiş olması şartıyla bunu manuel olarak oluşturabilirsiniz. | | İç | Dahili projeler, kuruluşunuza bir proje maliyetlerini izlemek için kullanılır. Dahili projelerdeki kaynak tüketimi yönetmek için bir planlama aracı sağlar. **Not:** Dahili projelerdeki hareketler yansıtılan olmadığından **geliri tahakkuk** veya **fatura teklifleri oluştur** sayfa.                                                                                                                                                                                                                                                                       | | Zaman | Zaman projeleri Hastalık için çalışanları izlemek için bir proje gibi ücrete tabi olmayan ve üretken olmayan etkinlikleri ile ilişkili zaman izlemek için kullanılır. Zaman projelerindeki hareketler deftere nakledilmez. Bunun yerine, çalışan yararlanım raporlarına dahil edilir. Zaman projelerinde yalnızca saat hareketleri kaydedilebilir. Bu saatleri projeye kaydetmek için bir saat günlüğü veya zaman çizelgesi kullanılır. Saat kaydı yapıldıktan sonra proje hareketleri olarak görünür ancak karşılık gelen fiş işlemleri yoktur.

> [!NOTE] 
> Zaman projelerindeki hareketler yansıtılan olmadığından **Maliyetleri deftere**, **geliri tahakkuk**, veya **fatura teklifleri oluştur** sayfa.                                                                                                                                                                                       |
...
Kaynak planlama işlevselliği kullanabileceðiniz durumlarýn bazıları şunlardır:
...
Yönetmek ve projelerinizi denetlemek için iki yol vardır: Proje tahminleri ve Proje bütçeleri. Organizasyonunuz bir operasyonel perspektife sahipse ve belirli hareketlerden elde edilen gelirlere ve çıkan maliyetlere odaklanıyorsa tahmin yöntemini kullanabilirsiniz. Ancak, organizasyonunuz daha çok mali tutarlara odaklanıyorsa bütçe yöntemini kullanabilirsiniz.
...
-   Madde/Hayır bağlantı sırası *** – bağlantı proje için madde gereksinimi için tüketilen. Bu yöntemi kullanarak, üretimin durumu **Başlatıldı** olduğunda veya bitti olarak raporlandığında gerçek proje maliyetlerini görüntüleyebilirsiniz. Maliyetler, üretim için kullanılan hammaddelere ve saatlere yönelik birden çok proje madde hareketi olarak deftere nakledilir. Üretimdeki projelerin takip edildiği BOM hiyerarşisindeki seviyeyi de tanımlayabilirsiniz.
...
-   Maddeleri şirketin stokundan sipariş etmek için siparişi mutlaka bir madde gereksinimi olarak girmeniz gerekir. Kullanırsanız, **madde gereksinimleri** sayfasında ayarlayabileceğiniz gereksinimini böylece öğeleri olarak kısmi teslimatlar almak. Bu nedenle, öğeler gereklidir kadar bir miktar madde tüketiminin erteleyebilirsiniz.
...
> [!NOTE] 
> Maddeler için ambalaj zaten işaretlenmiş ise proje ile ilgili satış siparişi için sevk irsaliyesini iptal edilemez. 
...
Microsoft Dynamics 365 işlemleri için otomatik olarak tahmin edilen tahminler azaltmak değildir. Bu nedenle, proje tamamlandığında karşılaştırma için bir temel oluşturmak için Sabit fiyatlı projede bir orijinal tahmin modelinin korunması iyi bir fikirdir. 
> [!NOTE]Bu yöntemi seçtiğinizde, en az iki tahmin modellerini kullanın. bir modeli orijinal tahmini içermelidir. Diğer model için, tahmin modellerini başka bir modelden kopyalamanız gerekir. Bu yöntem sadece Sabit fiyatlı projeler ve Yatırım projeleri için geçerlidir.</td>
> </tr>
<tr class="odd">
<td>Kalan bütçe</td>
...
-   **Fatura tarihi:** 31 Mart 2012. Bu tarihi fatura sıklığı temel alarak belirlenir. Bu örnek için, fatura sıklığını güncel ay olarak ayarladınız. Bu nedenle, Mart ayında nakledilen tüm hareketler ayın son günü faturalandırılır.
-   **Son tarih:** 14 Nisan 2012. Bu tarih, proje için ayarlanan ödeme koşullarını temel alarak belirlenir. Bu örnek için ödeme süresini 14 gün seçtiniz. Bu nedenle, fatura tarihine 14 gün eklenerek vade tarihi 14 Nisan 2012 olarak bulunur.
-   **Beklenen satış ödeme tarihi:** 27 Nisan 2012. Bu tarihi gün sayısını ekleyerek hesaplanır **genel tampon gün** alanında bulunan **proje yönetimi ve muhasebe parametreleri** gün sayısı sayfaya **bireysel arabelleği gün** alanına **proje sözleşmeleri** sayfa ve gün sayısı toplam ekleme **son tarih** alan. Bu örnekte **Genel tampon günleri** alanına **3** ve **Ayrı tampon günleri** alanına **10** değerini girdiniz. Bu nedenle, vade tarihine 13 gün eklenerek beklenen satış ödemesi tarihi 27 Nisan 2012 olarak belirlenir.
...
-   **Son tarih:** 16 Mart 2012. Ödeme koşullarını 14 gün olarak ayarlanır.
-   **Beklenen satış ödeme tarihi:** 29 Mart 2012. Üç genel tampon gün ve bireysel arabelleği 10 gün hesaplama içerir.
...
> [!NOTE] 
> Proje satınalma siparişi oluşturulduğunda satınalma siparişi için son tarihi satıcı hareketi üzerinde temel alır. Vade tarihi, varsayılan ayarlar tarafından belirlenmez. 
...
> [!NOTE] 
> Kullandığınızda **maliyet denetimi** sayfa proje maliyetlerini geçerli durumunu görüntülemek için özgün ve Kalan bütçe seçilmedi tahmin modellerini kullanın. Maliyetleri hesaplarken diğer tahmin modellerini seçerseniz hesaplama sonuçları kesin olmayacaktır.
